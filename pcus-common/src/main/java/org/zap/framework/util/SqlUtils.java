...
public class SqlUtils {
	...
	public static String inClause(String field, String[] values) {
		...
		StringBuilder inbuffer = new StringBuilder("(  1 <> 1");
	...
	//	System.out.println(inClause("aaaa", new String[] {"a", "b", "c"}));
	//	System.out.println(inClause("aaaa", new String[] {}));
    //
	...
	//	arr.add("c");
    //
	//	System.out.println(inClause("aaaa", new ArrayList<>()));
	//	System.out.println(inClause("bbbb", arr));
    //
    //
	//}
}
