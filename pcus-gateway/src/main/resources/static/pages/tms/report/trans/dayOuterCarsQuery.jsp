...
<div style="display: none">
    <form id="download" method="POST" target="_blank" action="/tms/report/trans/dayOuterCarsQuery/exportExcel">
...
<script type="text/javascript">
    //上下文路径
    var basePath = rootPath + '/tms/report/trans/dayOuterCarsQuery/';
    //页面控件
    ...
    var gridOption = {
        columns: [
            ...
            {
                display: '外协单位', name: 'carrier_name', align: 'left', minWidth: 50, width: '5%',
            },
            {
    ...
    var defaultAction = function (item) {
        switch (item.id) {
            case"search":
                ...
                break;
            case"export":
                xlsUtil.exp($('#download'), mainGrid, "单日外派车次.xls", {where: searchForm.getSearchFormData(true, defaultSearchFilter)});
                break;
            case "refresh":
                mainGrid.reload();
                break;
