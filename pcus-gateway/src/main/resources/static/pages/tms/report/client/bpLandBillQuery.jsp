...
<script type="text/javascript">
    ...
    var gridOption = {
        columns: [
            {display: '收货客户号', name: 'a', align: 'left', minWidth: 50, width: '10%'},
            {display: '厂家名称', name: 'b', align: 'left', minWidth: 50, width: '10%'},
            {display: '', name: 'c', align: 'left', minWidth: 50, width: '10%'},
            {display: '车次', name: 'd', align: 'left', minWidth: 50, width: '10%'},
            {display: '货运吨数', name: 'e', align: 'left', minWidth: 50, width: '8%'},
            {display: '单价', name: 'f', align: 'left', minWidth: 50, width: '10%'},
            {display: '运费', name: 'g', align: 'left', minWidth: 50, width: '8%'},
            {display: '备注', name: 'h', align: 'left', minWidth: 50, width: '15%'}
        ],
        pageSize: 50,
