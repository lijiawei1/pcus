  ...
  var defaultAction = function (item) {
    switch (item.id) {
      case"search":
        ...
        break;
      case"export":
        xlsUtil.exp($('#download'), mainGrid, "安盈对账单.xls", {where: searchForm.getSearchFormData(false, defaultSearchFilter)})
        break;
      case "refresh":
        mainGrid.reload();
        break;
    ...
    buttons: [
      {
        ...
        onclick: function (item, dialog) {
          ...
          if(y && m){
            $(".l-panel-header-text").html(y+'年'+m+'月份安盈对帐明细');
          }
          else if(y==''&& m){
            $(".l-panel-header-text").html(m+'月份安盈对帐明细');
          }
          else if(y && m==''){
            $(".l-panel-header-text").html(y+'年安盈对帐明细');
          }else{
            $(".l-panel-header-text").html('安盈对帐明细');
          }
          mainGrid.set('parms', [{
            name: 'where',
