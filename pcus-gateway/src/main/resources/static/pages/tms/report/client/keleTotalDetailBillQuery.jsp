...
<div style="display: none">
    <form id="download" method="POST" target="_blank" action="/tms/report/kele/client/keleTotalDetailBillQuery/exportExcel">
...
<script type="text/javascript">
    //上下文路径
    var basePath = rootPath + '/tms/report/kele/client/keleTotalDetailBillQuery/';
    //页面控件
    ...
    var gridOption = {
        columns: [
            {display: '送达目的地', name: 'a', align: 'left', minWidth: 50, width: '5%'},
            {
    ...
    var defaultAction = function (item) {
        switch (item.id) {
            case"search":
                ...
                break;
            case"export":
                xlsUtil.exp($('#download'), mainGrid, "汽水运输情况汇总表.xls", {where: searchForm.getSearchFormData(false, defaultSearchFilter)})
                break;
            case "refresh":
                mainGrid.reload();
                break;
