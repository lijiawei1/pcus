        ...
        <div id="mainTab">
            <div tabid="editTab" title="单据编辑" lselected="true" data-url="${path}/tms/bas/clientlinkman/loadPage">
                <div class="toolbar-wrapper form-toolbar">
                    <div class="l-toolbar" id="toolbar"> </div>
                </div>
            ...
            <div tabid="linkmanGridTab" title="价格合约" data-url="${path}/tms/bas/contractitem/loadPage?pk_id=${pk_id}">
...
<script type="text/javascript">
    ...
    var isDeleteBtn = disabledButtons.indexOf('deleteFile') >= 0;
    ...
    var mainForm = formPanel.ligerForm({
        ...
        fields: [
            ...
            },
            {
                ...
                validate: {required: true, messages: {required: '合同名称不能为空。'}}
            },
            {
                display: '自定义编号', name: 'contract_own',
                attr: {
                    maxlength: 50
                },
            ...
            {
                display: '乙方公司应用范围', name: 'service_range',
                attr: {
                    maxlength: 50
                },
                 newline: false, type: 'text'
            ...
            {
                display: '签订地点', name: 'contract_place',
                attr: {
                    maxlength: 50
                },  newline: false, type: 'text'
            },
    ...
    LG.powerToolBar($('#toolbar'), {
        items: [
            { id: 'save', text: '保存', click: saveClient, icon: 'save' },
            { id: 'use', text: client.state === 'STATE_11_USE'? '失效' : '使用', click: setState, icon: client.state === 'STATE_11_USE'? 'stop' : 'use', status: ['OP_INIT'] },
            { id: 'backtrack', text: '返回', click: backtrackFun, icon: 'backtrack' },
            { id: 'btnRefresh', text: '刷新', click: refresh, icon: 'refresh' }
        ]
    });
    (disabledButtons.indexOf('addFlile') >= 0) && $('#addCard').hide();
