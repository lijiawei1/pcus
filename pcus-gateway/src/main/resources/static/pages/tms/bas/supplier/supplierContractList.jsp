...
<script>
    ...
    var where = JSON2.stringify({
        op: 'and',
        rules: [{field: 'DR', value: '0', op: 'equal'}, {field: 'second_id', value: client_id, op: 'equal'}]
    });
    ...
    var gridOption = {
        ...
        onDblClickRow:function(rowData,id,rowDom,fn){
            top.f_addTab(rowData.pk_id, '车队合同[' + rowData.contract_no + ']', basePath + 'loadCard'
            + '?module=' + '基础资料' + '&detailFunction=' + '车队合同' + '&function=' + '车队管理' + '&pk_id=' + rowData.pk_id);
        }
    };
    ...
    var mainFormOption = {
        fields: [
            ...
            {
                display: '甲方', name: 'first_id', labelWidth: 100,
                width: 170,
...
<script type="text/javascript">
    defaultSearchFilter["and"].push({field: 'second_id', value: client_id, op: 'equal', type: 'string'});
    $(function () {
        //初始化编辑按钮
        $mainGrid.on('click', 'a.row-edit-btn', function (e) {
            ...
            //进入客户资料信息页签
            top.f_addTab(selected.pk_id, '车队合同[' + selected.contract_no + ']', basePath + 'loadCard'
                    + '?module=' + '基础资料' + '&detailFunction=' + '车队合同' + '&function=' + '车队管理' + '&pk_id=' + selected.pk_id);
