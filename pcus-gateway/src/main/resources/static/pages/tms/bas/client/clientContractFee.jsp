...
<div style="display: none">
    <form id="download" method="POST" target="_blank" action="/tms/bas/contractfee/excelTmpl">
...
<script>
    ...
    //上下文路径
    var basePath = rootPath + '/tms/bas/contractfee/';
    ...
    var gridOption = {
        columns: [
            ...
            {display: '孖拖（主）', name: 'twindrag_main_name', id: 'twindrag_main_name', quickSort: false, align: 'left', minWidth: 50, width: '10%', hide: true,
            ...
            {display: '孖拖（副）', name: 'twindrag_second_name', id: 'twindrag_second_name', quickSort: false, align: 'left', minWidth: 50, width: '10%', hide: true,
                render: function (item) {
                    if (!item.twindrag_second) return '<input type="checkbox" name="checkbox" disabled="disabled" style="margin-top:4px;">';
                    return '<input type="checkbox" name="checkbox" checked="checked" disabled="disabled" style="margin-top:4px;">';
                }
            },
            {display: '带货', name: 'take_goods_name', id: 'take_goods_name', quickSort: false, align: 'left', minWidth: 50, width: '10%', hide: true,
                render: function (item) {
                    if (!item.take_goods) return '<input type="checkbox" name="checkbox" disabled="disabled" style="margin-top:4px;">';
                    return '<input type="checkbox" name="checkbox" checked="checked" disabled="disabled" style="margin-top:4px;">';
                }
            },
            {display: '外派', name: 'assignment_name', quickSort: false, id: 'assignment_name', align: 'left', minWidth: 50, width: '10%', hide: true,
                render: function (item) {
                    if (!item.assignment) return '<input type="checkbox" name="checkbox" disabled="disabled" style="margin-top:4px;">';
                    return '<input type="checkbox" name="checkbox" checked="checked" disabled="disabled" style="margin-top:4px;">';
                }
            },
            {display: '甩挂', name: 'trailer_name', id: 'trailer_name', align: 'left', quickSort: false, minWidth: 50, width: '10%', hide: true,
                render: function (item) {
            ...
            {display: '最小金额', name: 'min_amount', id: 'min_amount', align: 'left', minWidth: 50, width: '5%'},
            {display: '最大金额', name: 'max_amount', id: 'max_amount', align: 'left', minWidth: 50, width: '5%'}
        ],
        pageSize: 20,
    ...
    var filterFormOption = {
        fields: [
            {display: "姓名", name: "name", newline: false, labelWidth: 90, width: 170, space: 30, type: "text", cssClass: "field"},
    ...
    var mainFormOption = {
        fields: [
            {display: "客户", name: "client", newline: false, labelWidth: 90, width: 170, space: 30, type: "taginput", cssClass: "field",
                options: {
                    url: basePath + 'getClient'
                }
            },
            {display: "车型", name: "car_type", newline: false, labelWidth: 90, width: 170, space: 30, type: "taginput", cssClass: "field",
                options: {
                    url: rootPath + '/tms/bas/dict/getData?query=car_type'
                }
            },
            {display: "柜型", name: "cntr_type", newline: false, labelWidth: 90, width: 460, space: 30, type: "taginput", cssClass: "field",
                options: {
...
//            {display: "装货单位", name: "load_unit", newline: true, labelWidth: 90, width: 460, space: 30, type: "tagInput", cssClass: "field",
//                options: {
//                    split: ',',
//                    ligerComboBoxOptions: {
//                        url: basePath + 'getloadUnloadUnit?id=' + contract_id
//                    }
//                }
//            },
            {
            ...
            {
                display: "装货报价区域", name: "load_region", newline: true, labelWidth: 90, width: 460, space: 30, type: "taginput", cssClass: "field",
                options: {
                    url: basePath + 'getRegions',
                    freeInput: true
                }
            },
            {display: "装货地", name: "load_address", newline: false, labelWidth: 90, width: 170, space: 30, type: "taginput", cssClass: "field",
                options: {
                    url: basePath + 'getloadUnloadAddress?id=' + contract_id
                }
            },
            {display: "卸货单位", name: "unload_unit", newline: false, labelWidth: 90, width: 460, space: 30, type: "taginput", cssClass: "field",
                options: {
                    url: basePath + 'getloadUnloadUnit?id=' + contract_id
                }
            },
            {
                display: "卸货报价区域", name: "unload_region", newline: true, labelWidth: 90, width: 460, space: 30, type: "taginput", cssClass: "field",
                options: {
                    url: basePath + 'getRegions',
                    freeInput: true
                }
            },
            {display: "卸货地", name: "unload_address", newline: false, labelWidth: 90, width: 170, space: 30, type: "taginput", cssClass: "field",
                options: {
                    url: basePath + 'getloadUnloadAddress?id=' + contract_id
                }
            },
            {display: "提柜地", name: "cntr_in_place", newline: true, labelWidth: 90, width: 460, space: 30, type: "taginput", cssClass: "field",
                options: {
                    url: basePath + 'getloadUnloadAddress?id=' + contract_id
                }
            },
            {
                display: "提柜报价区域", name: "gate_out_region", newline: true, labelWidth: 90, width: 460, space: 30, type: "taginput", cssClass: "field",
                options: {
                    url: basePath + 'getRegions',
                    freeInput: true
                }
            ...
            {
                display: "还柜地", name: "cntr_out_place", newline: true, labelWidth: 90, width: 460, space: 30, type: "taginput", cssClass: "field",
                options: {
                    url: basePath + 'getloadUnloadAddress?id=' + contract_id
                }
            },
            {
                display: "还柜报价区域", name: "gate_in_region", newline: true, labelWidth: 90, width: 460, space: 30, type: "taginput", cssClass: "field",
                options: {
                    url: basePath + 'getRegions',
                    freeInput: true
                }
            ...
            {display: "操作单位", name: "oper_unit", newline: false, labelWidth: 90, width: 170, space: 30, type: "select", cssClass: "field",
                options: {
            ...
            {display: "急单类型", name: "urgent_order", newline: false, labelWidth: 90, width: 170, space: 30, type: "select", cssClass: "field",
                options: {
            ...
            {
                display: "自定义业务", name: "client_busi", newline: true, labelWidth: 90, width: 460, space: 30, type: "taginput", cssClass: "field",
                options: {
            ...
            {display: "孖拖（主）", name: "twindrag_main", newline: false, labelWidth: 90, width: 170, space: 30, type: "checkbox", cssClass: "field"},
            {display: "孖拖（副）", name: "twindrag_second", newline: false, labelWidth: 90, width: 170, space: 30, type: "checkbox", cssClass: "field"},
            {display: "带货", name: "take_goods", newline: false, labelWidth: 90, width: 170, space: 30, type: "checkbox", cssClass: "field"},
            {display: "外派", name: "assignment", newline: false, labelWidth: 90, width: 170, space: 30, type: "checkbox", cssClass: "field"},
            {display: "甩挂", name: "trailer", newline: false, labelWidth: 90, width: 170, space: 30, type: "checkbox", cssClass: "field"},
            {display: "报价", name: "amount", newline: false, labelWidth: 90, width: 460, space: 30, type: "number", cssClass: "field", validate: {required: true, min: 0}},
            {display: "最小金额", name: "min_amount", newline: false, labelWidth: 90, width: 460, space: 30, type: "number", cssClass: "field", validate: {required: false, min: 0}},
            {display: "最大金额", name: "max_amount", newline: false, labelWidth: 90, width: 460, space: 30, type: "number", cssClass: "field", validate: {required: false, min: 0}},
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            mainGrid.resetColumnsWidth(true);
        }
    });
    ...
    function initFields() {
        if (isFirst) {
            for (var i = 0; i < Object.keys(mainForm.editors).length; i++) {
                ...
                || name == "max_amount" || name == "min_amount") {
                    continue;
                }
        ...
        items: [
            {
                ...
                menu: {
                    items: [
                        ...
                        { id: 'exportExcel', text: '导出报价', click: excelExport, status: ['OP_INIT']},
                        { id: 'importExcel', text: '导入报价', click: excelImport, status: ['OP_INIT']}
                    ]
                }
            },
