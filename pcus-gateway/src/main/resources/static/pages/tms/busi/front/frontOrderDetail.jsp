...
<script>
    ...
    //上下文路径
    var basePath = rootPath + '/tms/busi/frontOrderDetail/';
    ...
    var gridOption = {
        columns: [
            {
                display: '物料名称', name: 'name', align: 'left', minWidth: 50, width: '10%',
                editor: {
                    type: 'text'
                }
            },
            {
                display: '物料代码', name: 'code', align: 'left', minWidth: 50, width: '10%',
                editor: {
                    type: 'text'
                }
            },
            ...
            {
                display: '规格型号', name: 'standard', align: 'left', minWidth: 50, width: '10%',
                editor: {
                    type: 'text'
                }
            },
            ...
            {
                display: '重量', name: 'weight', align: 'left', minWidth: 50, width: '10%',
                editor: {
                    type: 'newnumberbox',
                    ext: {
                        minValue: 0,
            ...
            {
                display: '体积', name: 'volume', align: 'left', minWidth: 50, width: '10%',
                editor: {
                    type: 'newnumberbox',
                    ext: {
                        minValue: 0,
            ...
            {
                display: '价格', name: 'price', align: 'left', minWidth: 50, width: '10%',
                editor: {
                    type: 'newnumberbox',
                    ext: {
                        minValue: 0,
            ...
            {
                display: '金额', name: 'amount', align: 'left', minWidth: 50, width: '10%',
                editor: {
                    type: 'newnumberbox',
                    ext: {
                        minValue: 0,
            ...
            {
                display: '单位', name: 'unit', align: 'left', minWidth: 50, width: '10%',
                editor: {
                    type: 'select',
                    data: data_unit,
                },
            ...
            {
                display: '批次号', name: 'batch_no', align: 'left', minWidth: 50, width: '10%',
                editor: {
                    type: 'text'
                }
            },
            {
                display: '运单号', name: 'bill_no', align: 'left', minWidth: 50, width: '10%'
            },
            {
