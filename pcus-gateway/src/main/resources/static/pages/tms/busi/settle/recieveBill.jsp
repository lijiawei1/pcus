...
<div class="tabWrapper">
    <div class="tabWrapper-inner">
        <div id="mainTab">
            <div tabid="maintab1" title="应收账单"data-url="${path}/tms/settle/recieve/loadPage" >
                <iframe frameborder="0" name="makebillpay"></iframe>
            </div>
            <div tabid="maintab2" title="应收账单制作" data-url="${path}/tms/settle/makebillrecieve/loadPage">
