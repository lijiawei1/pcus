...
<script>
    ...
    var basePath = rootPath + '/tms/busi/transMonList/';
    ...
    $(function () {
        ...
        mainGrid = $('#mainGrid').ligerGrid({
            columns: [
                ...
                {
                    display: '客户名称',
                    name: 'client_name', minWidth: 100, width: 200, sortable: false,

                },
                {
                    display: '装货地',
                    name: 'lau_orgs', minWidth: 130, width: 130, sortable: false,
                },
                {
                    display: '装货区域',
                    name: 'lau_regions', minWidth: 130, width: 130, sortable: false,
                },
                {
                    display: '预约装卸时间',
                ...
                {
                    display: '车牌号',
                    name: 'car_no', minWidth: 100, width: 100, sortable: false,
                },
                {
                    display: '轻公里数',
                    name: 'e_km', minWidth: 60, width: 60, sortable: false,
                },
                {
                    display: '重公里数',
                    name: 'f_km', minWidth: 60, width: 60, sortable: false,
                },
                {
                    display: '签收重量',
                    name: 'total_weight', minWidth: 60, width: 60, sortable: false,
                },
                {
                    display: '无公里数',
                    name: 'null_km', minWidth: 80, width: 80, sortable: false,
                    render:function(item) {
                        return '<input class="grid-check" type="checkbox" '+(item.null_km == 1 ? 'checked' : '')+' onclick="return false"/>'
                    }
                },
                {
                    display: '无油耗',
                    name: 'null_fuel', minWidth: 80, width: 80, sortable: false,
                    render:function(item) {
                        return '<input class="grid-check" type="checkbox" '+(item.null_fuel == 1 ? 'checked' : '')+' onclick="return false"/>'
                    }
                },
                {
                    display: '未注册车牌号',
                    name: 'car_no_invalid', minWidth: 80, width: 80, sortable: false,
                    render:function(item) {
                        return '<input class="grid-check" type="checkbox" '+(item.car_no_invalid == 1 ? 'checked' : '')+' onclick="return false"/>'
                    }
                },
                {
                    display: '无结算日期',
                ...
                {
                    display: '更新语句',
                    name: 'update_sql', minWidth: 800, width: 800, sortable: false,
                }
            ],
            pageSize: 50,
...
//            sortOrder: 'DESC'
     ...
     /*   //初始化编辑按钮
        ...
        function excelExport () {
            ...
            xlsUtil.exp($("#download"), mainGrid, '任务数据监控' + DateUtil.dateToStr('yyyy-MM-dd') + '.xls');
        }
