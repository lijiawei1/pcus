...
<script>
    ...
    var basePath = rootPath + '/tms/busi/chargeMonList/';
    ...
    $(function () {
        ...
        mainGrid = $('#mainGrid').ligerGrid({
            columns: [
                ...
                {
                    display: '收款方主键为空',
                    name: 'null_payee_id', minWidth: 80, width: 80, sortable: false,
                ...
                {
                    display: '付款方名称无效',
                    name: 'payer_invalid', minWidth: 80, width: 80, sortable: false,
                    render:function(item) {
                        return '<input class="grid-check" type="checkbox" '+(item.payer_invalid == 1 ? 'checked' : '')+' onclick="return false"/>'
                    }
                },
                {
                    display: '付款方主键为空',
                    name: 'null_payer_id', minWidth: 80, width: 80, sortable: false,
                    render:function(item) {
...
//            sortOrder: 'DESC'
     ...
     /*   //初始化编辑按钮
        ...
        function excelExport () {
            ...
            xlsUtil.exp($("#download"), mainGrid, '应收数据监控' + DateUtil.dateToStr('yyyy-MM-dd') + '.xls');
        }
