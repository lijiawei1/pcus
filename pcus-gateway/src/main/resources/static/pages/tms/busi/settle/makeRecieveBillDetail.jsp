...
<script>
    ...
    var data_dict = ${dict};
    //上下文路径
    var basePath = rootPath + '/tms/settle/makebilldetail/';
    ...
    var gridOption = {
        columns: [
            ...
            {
                display: '装卸单位信息', name: '', align: 'left', minWidth: 50, width: '10%',
                render: function (item) {
        ...
        pageSize:50,
        colDraggable: true,
        localStorageName: 'makeRecieveBillDetail' + user.id,
    };
...
<script type="text/javascript">
    defaultSearchFilter["and"].push(clauseClient);
