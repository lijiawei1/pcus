...
<script>
    ...
    //上下文路径
    var basePath = rootPath + '/tms/settle/paydetail/';
    ...
    var gridOption = {
        columns: [
            ...
            {display: '任务号', name: 'trans_bill_no', align: 'left', minWidth: 50, width: '8%'},
    ...
    var btnClick = function (item) {
        switch (item.id) {
            case "export":
                    xlsUtil.exp($("#download"), mainGrid, '应付账单明细' + DateUtil.dateToStr('yyyy-MM-dd') + '.xls',
                            {pk_id: client_id});
                break;
            case "delete":
                //跳转到新页签 编辑
...
//                        });
    ...
    var toolbarOption = {
        items: [
            ...
            {id: 'export', text: '导出', click: btnClick, icon: 'export', status: ['OP_INIT']},
