...
<script>
    ...
    var basePath = rootPath + '/tms/busi/orderMonList/';
    ...
    $(function () {
        ...
        mainGrid = $('#mainGrid').ligerGrid({
            columns: [
                {
                    //行内按钮
                    display: '编辑', align: '', minWidth: 30, width: '3%', sortable: false,
                ...
                {
                    display: '装货地',
                    name: 'load_org', minWidth: 130, width: 130, sortable: false,
                },
                {
                    display: '装货区域',
                    name: 'load_region', minWidth: 130, width: 130, sortable: false,
                },
                {
                    display: '卸货地',
                    name: 'unload_org', minWidth: 130, width: 130, sortable: false,
                },
                {
                    display: '卸货区域',
                    name: 'unload_region', minWidth: 130, width: 130, sortable: false,
                },
                {
                    display: '预约装卸时间',
                    name: 'cntr_work_time', minWidth: 150, width: 150, sortable: false,
                },
                {
                    display: '结算时间',
                ...
                {
                    display: '非合同客户',
                    name: 'not_contract_client', minWidth: 80, width: 80, sortable: false,
                    render:function(item) {
                        return '<input class="grid-check" type="checkbox" '+(item.not_contract_client == 1 ? 'checked' : '')+' onclick="return false"/>'
                    }
                },
                {
                    display: '缺失客户主键',
                    name: 'null_client_id', minWidth: 80, width: 80, sortable: false,
                    render:function(item) {
                        return '<input class="grid-check" type="checkbox" '+(item.null_client_id == 1 ? 'checked' : '')+' onclick="return false"/>'
                    }
                },
                {
                    display: '装货单位无效',
                    name: 'load_org_invalid', minWidth: 80, width: 80, sortable: false,
                    render:function(item) {
                        return '<input class="grid-check" type="checkbox" '+(item.load_org_invalid == 1 ? 'checked' : '')+' onclick="return false"/>'
                    }
                },
                {
                    display: '装货区域无效',
                    name: 'load_region_invalid', minWidth: 80, width: 80, sortable: false,
                    render:function(item) {
                        return '<input class="grid-check" type="checkbox" '+(item.load_region_invalid == 1 ? 'checked' : '')+' onclick="return false"/>'
                    }
                },
                {
                    display: '卸货单位无效',
                    name: 'unload_org_invalid', minWidth: 80, width: 80, sortable: false,
                    render:function(item) {
                        return '<input class="grid-check" type="checkbox" '+(item.unload_org_invalid == 1 ? 'checked' : '')+' onclick="return false"/>'
                    }
                },
                {
                    display: '卸货区域无效',
                    name: 'unload_region_invalid', minWidth: 80, width: 80, sortable: false,
                    render:function(item) {
                        return '<input class="grid-check" type="checkbox" '+(item.unload_region_invalid == 1 ? 'checked' : '')+' onclick="return false"/>'
                    }
                },
                {
                    display: '结算日期为空',
                    name: 'null_settle_date', minWidth: 80, width: 80, sortable: false,
                    render:function(item) {
                        return '<input class="grid-check" type="checkbox" '+(item.null_settle_date == 1 ? 'checked' : '')+' onclick="return false"/>'
                    }
                },
                {
                    display: '更新语句',
...
//            sortOrder: 'DESC'
     ...
     /*   //初始化编辑按钮
        ...
        function excelExport () {
            ...
            xlsUtil.exp($("#download"), mainGrid, '运单数据监控' + DateUtil.dateToStr('yyyy-MM-dd') + '.xls');
        }
