...
<div id="layout">
    ...
    <div class="content-wrapper grid-wrapper">
        ...
        <div class="quick-search" id="quickSearch">
            <a class="qs-item visited qs-item-red" href="javascript:;" data-state="ALL" >全部(<span>0</span>)</a>
            <a class="qs-item qs-item-cyan" href="javascript:;" data-state="新记录" >新记录(<span>0</span>)</a>
            <a class="qs-item qs-item-blue" href="javascript:;" data-state="已审核" >已审核(<span>0</span>)</a>
            <a class="qs-item qs-item-orange" href="javascript:;" data-state="已完成" >已完成(<span>0</span>)</a>
            <a class="qs-item qs-item-pink" href="javascript:;" data-state="已回单" >已回单(<span>0</span>)</a>
            <a class="qs-item qs-item-gray" href="javascript:;" data-state="已核费用" >已核费用(<span>0</span>)</a>
        </div>
    </div>
</div>
<!-- 高级搜索 -->
...
<div style="display: none">
    <form id="download" method="POST" target="_blank" action="${path}/tms/busi/front/excelTmpl">
...
<script src="${path}/js/tms/busi/front/frontOrderList.js?t=${applicationScope.sys_version}"></script>
</html>