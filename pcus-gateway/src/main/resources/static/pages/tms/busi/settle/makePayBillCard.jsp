    ...
    <div class="tabWrapper-inner">
        <div id="mainTab">
            <div tabid="editTab" title="账单制作" lselected="true"
                 data-url="${path}/tms/settle/makebillpaydetail/loadPage?pk_id=${client_id}&supplier_id=${supplier_id}">
                <iframe frameborder="0" name="editTab"></iframe>
            </div>
            <div tabid="linkmanGridTab" title="结算信息"
                 data-url="${path}/tms/settle/settleInfo/loadCard?pk_id=${client_id}&type=2">
