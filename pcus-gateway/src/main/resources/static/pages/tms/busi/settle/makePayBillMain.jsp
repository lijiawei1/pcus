...
<script>
    ...
    //上下文路径
    var basePath = rootPath + '/tms/settle/makebillpay/';
    ...
    var gridOption = {
        columns: [
            ...
            {
                display: '应付总额', name: 'total', align: 'left', minWidth: 50, width: '23%'
            }
        ],
        pageSize: 50,
...
<script>
    $(function () {
        ...
        mainGrid.bind('dblClickRow', function (rowdata) {
            ...
            //进入客户资料信息页签
            top.f_addTab(rowdata.pk_id + "1", '应付账单制作[' + rowdata.name + ']', basePath + 'loadCard'
                    + '?module=' + param.module + '&function=应付账单制作&pk_id=' + rowdata.pk_id + '&supplier_id=' + rowdata.supplier_id + '&from=' + basePath + 'loadPage');
        });
    });
    //初始化编辑按钮
    $mainGrid.on('click', 'a.row-edit-btn', function (e) {
        ...
        //进入客户资料信息页签
        top.f_addTab(selected.pk_id + "1", '应付账单制作[' + selected.name + ']', basePath + 'loadCard'
                + '?module=' + param.module + '&function=应付账单制作&pk_id=' + selected.pk_id + '&supplier_id=' + selected.supplier_id + '&from=' + basePath + 'loadPage');
