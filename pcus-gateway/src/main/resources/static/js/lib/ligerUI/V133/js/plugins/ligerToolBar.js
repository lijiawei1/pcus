...
(function ($)
{
    ...
    $.ligerui.controls.ToolBar.ligerExtend($.ligerui.core.UIComponent, {
        ...
        _setItems: function (items)
        {
            ...
            {
                /**
                 * 2016-11-02 新增ignore属性判断
                 * */
                if(!item.ignore) g.addItem(item);
            });
        },
        ...
        addItem: function (item)
        {
            ...
            /**
             * 2016-12-05 增加初始状态为禁用状态的判断
             * */
            var ditem = $('<div class="l-toolbar-item l-panel-btn ' + (item.disable ?  'l-toolbar-item-disable' : '') + '"><span></span><div class="l-panel-btn-l"></div><div class="l-panel-btn-r"></div></div>');
			...
			if (item.menu) {
                ...
                ditem.on({
                    click: function () {
                        item.menuType ? hideMenu.call(this) : showMenu.call(this);
                    },
                    touchend: function (e) {
                        item.menuType ? hideMenu.call(this) : showMenu.call(this);
                        e.preventDefault();
