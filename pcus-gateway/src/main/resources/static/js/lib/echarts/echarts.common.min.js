!function (t, e) {
    ...
    return function (t) {
        ...
        t.exports = i(2), i(85), i(79), i(90), i(162), i(195), i(175), i(34), i(186), i(181), i(180), i(165), i(187), i(203)
    }, function (t, e, i) {
        function n(t) {
        ...
        function A(t) {
            return !!P[z.call(t)] || t instanceof L
        }
        ...
        }, z = Object.prototype.toString, O = Array.prototype, E = O.forEach, R = O.filter, B = O.slice, N = O.map, V = O.reduce, F = {
            inherits: u,
            mixin: d,
            clone: n,
            merge: r,
        ...
        function o(t, e, i) {
            i = i || {}, "string" == typeof e && (e = W[e]), e && D(G, function (t) {
                t(e)
        ...
        function s(t, e, i) {
            var n = this._api;
            D(this._componentsViews, function (r) {
                var o = r.__model;
                r[t](o, e, n, i), p(o, r)
         ...
         */
        var m = i(111), v = i(78), y = i(28), x = i(112), _ = i(10), b = i(13), w = i(54), M = i(25), S = i(3), A = i(67), T = i(1), C = i(22), I = i(15), k = i(21), D = T.each, L = ["echarts", "chart", "component"], P = ["transform", "filter", "statistic"];
        ...
        z.getDom = function () {
            ...
            this._model && !e || (this._model = new m(null, null, this._theme, new x(this._api))), this._model.setOption(t, G), O.prepareAndUpdate.call(this), !i && this._zr.refreshImmediately()
        }, z.setTheme = function () {
        ...
        var O = {
            update: function (t) {
                ...
                var e = this._model;
                l.call(this, "component", e), l.call(this, "chart", e), O.update.call(this, t)
            }
        };
        z.resize = function () {
            this._zr.resize();
        ...
        z.showLoading = function (t, e) {
            ...
            if (i) {
                ...
                for (var s, l = [], h = "highlight" === t.type || "downplay" === t.type, c = 0; c < o.length; c++) {
                    var u = o[c];
                    s = i.action(u, this._model), s = s || T.extend({}, u), s.type = n.event || s.type, l.push(s), h && O[r].call(this, u)
                }
                "none" !== r && !h && O[r].call(this, t), e || (s = a ? {
                    type: l[0].type,
                    batch: l
                } : l[0], this._messageCenter.trigger(s.type, s))
            }
        }, z.on = n("on"), z.off = n("off"), z.one = n("one");
        var R = ["click", "dblclick", "mouseover", "mouseout", "globalout"];
        z._initEvents = function () {
            ...
            D(this._componentsViews, function (i) {
                ...
                i.dispose(e, t)
            }), this._zr.dispose(), H[this.id] = null
        }, T.mixin(o, k);
        var B = [], N = {}, V = [], F = {}, G = [], Z = {}, W = {}, H = {}, q = {}, j = new Date - 0, X = new Date - 0, U = "_echarts_instance_", Y = {
            version: "3.1.3",
        ...
        Y.init = function (t, e, i) {
            ...
            var n = new o(t, e, i);
            return n.id = "ec_" + j++, H[n.id] = n, t.setAttribute && t.setAttribute(U, n.id), g(n), n
            ...
            T.isDom(t) ? t = Y.getInstanceByDom(t) : "string" == typeof t && (t = H[t]), t instanceof o && !t.isDisposed() && t.dispose()
            ...
            if (T.indexOf(L, t) < 0)throw new Error("stage should be one of " + L);
            var i = Z[t] || (Z[t] = []);
            i.push(e)
            ...
            event: "downplay",
            update: "downplay"
        }, T.noop), Y.graphic = i(3), Y.number = i(4), Y.format = i(9), Y.matrix = i(19), Y.vector = i(5), Y.util = {}, D(["map", "each", "filter", "indexOf", "inherits", "reduce", "filter", "bind", "curry", "isArray", "isString", "isObject", "isFunction", "extend"], function (t) {
            Y.util[t] = T[t]
        }), t.exports = Y
    }, function (t, e, i) {
        "use strict";
        ...
        function d(t, e, i, n, r) {
            var o = t ? "Update" : "", a = n && n.getShallow("animationDuration" + o), s = n && n.getShallow("animationEasing" + o);
            n && n.getShallow("animation") ? e.animateTo(i, a, s, r) : (e.attr(i), r && r())
        }

        var f = i(1), p = i(155), g = Math.round, m = i(6), v = i(22), y = i(19), x = i(5), _ = i(16), b = {};
        b.Group = i(26), b.Image = i(46), b.Text = i(65), b.Circle = i(146), b.Sector = i(152), b.Ring = i(151), b.Polygon = i(148), b.Polyline = i(149), b.Rect = i(150), b.Line = i(147), b.BezierCurve = i(145), b.Arc = i(144), b.LinearGradient = i(76), b.RadialGradient = i(140), b.BoundingRect = i(8), b.extendShape = function (t) {
            return m.extend(t)
        }, b.extendPath = function (t, e) {
            return p.extendFromString(t, e)
        }, b.makePath = function (t, e, i, n) {
            var r = p.createFromString(t, e), o = r.getBoundingRect();
            if (i) {
            ...
            e = e || {}, "group" === t.type ? t.traverse(function (t) {
                "group" !== t.type && s(t, e)
            }) : s(t, e), t.on("mouseover", l).on("mouseout", h), t.on("emphasis", c).on("normal", u)
        ...
        }, b.updateProps = f.curry(d, !0), b.initProps = f.curry(d, !1), b.getTransform = function (t, e) {
            ...
            return o = b.applyTransform(o, e, i), Math.abs(o[0]) > Math.abs(o[1]) ? o[0] > 0 ? "right" : "left" : o[1] > 0 ? "bottom" : "top"
        }, t.exports = b
    }, function (t, e) {
        function i(t) {
        ...
        n.linearMap = function (t, e, i, n) {
            ...
            var i, n = Math.floor(Math.log(t) / Math.LN10), r = Math.pow(10, n), o = t / r;
        ...
        var a = i(35), s = i(1), l = i(27), h = i(136), c = i(16), u = Math.abs;
        o.prototype = {
            constructor: o, type: "path", __dirtyPath: !0, strokeContainThreshold: 5, brush: function (t) {
                t.save();
                var e = this.style, i = this.path, o = r(e), a = n(e);
                this.__dirtyPath && (a && e.fill instanceof c && e.fill.updateCanvasGradient(this, t), o && e.stroke instanceof c && e.stroke.updateCanvasGradient(this, t)), e.bind(t, this), this.setTransform(t);
                var s = e.lineDash, l = e.lineDashOffset, h = !!t.setLineDash;
                this.__dirtyPath || s && !h && o ? (i = this.path.beginPath(t), s && !h && (i.setLineDash(s), i.setLineDashOffset(l)), this.buildPath(i, this.shape), this.__dirtyPath = !1) : (t.beginPath(), this.path.rebuildPath(t)), a && i.fill(t), s && h && (t.setLineDash(s), t.lineDashOffset = l), o && i.stroke(t), null != e.text && this.drawRectText(t, this.getBoundingRect()), t.restore()
                ...
                if (r(e) && (this.__dirty || !this._rect)) {
                    var o = this._rectWithStroke || (this._rectWithStroke = t.clone());
                    o.copy(t);
                    var a = e.lineWidth, s = e.strokeNoScale ? this.getLineScale() : 1;
                    return n(e) || (a = Math.max(a, this.strokeContainThreshold)), s > 1e-10 && (o.width += a / s, o.height += a / s, o.x -= a / s / 2, o.y -= a / s / 2), o
                }
        ...
        var n = i(9), r = i(4), o = i(1), a = i(12), s = ["x", "y", "z", "radius", "angle"], l = {};
        l.createNameEach = function (t, e) {
            ...
            getDataParams: function (t) {
                var e = this.getData(), i = this.seriesIndex, n = this.name, r = this.getRawValue(t), o = e.getRawIndex(t), a = e.getName(t, !0), s = this.getRawDataArray(), l = s && s[o];
                return {
                    seriesIndex: i,
                    seriesName: n,
                    name: a,
                ...
                e = e || "normal";
                var r = this.getData(), o = r.getItemModel(t), a = this.getDataParams(t);
                return null == i && (i = o.get(["label", e, "formatter"])), "function" == typeof i ? (a.status = e, i(a)) : "string" == typeof i ? n.formatTpl(i, a) : void 0
            ...
            return o.each(e, function (t, n) {
                if (o.isObject(t))for (var r = 0; r < i.length; r++) {
                    var a = i[r].exist;
                    if (!i[r].option && (null != t.id && a.id === t.id + "" || null != t.name && !l.isIdInner(t) && !l.isIdInner(a) && a.name === t.name + "")) {
        ...
        var r = i(12), o = i(1), a = Array.prototype.push, s = i(41), l = i(20), h = i(11), c = r.extend({
            type: "component",
            id: "",
            name: "",
            mainType: "",
        ...
        var n = i(1), r = i(9), o = i(7), a = i(10), s = r.encodeHTML, l = r.addCommas, h = a.extend({
            ...
            mergeDefaultAndTheme: function (t, e) {
                ...
                for (var i = t.data || [], r = 0; r < i.length; r++)i[r] && i[r].label && o.defaultEmphasis(i[r].label, ["position", "show", "textStyle", "distance", "formatter"])
            },
            ...
            formatTooltip: function (t, e) {
                var i = this._data, r = this.getRawValue(t), o = n.isArray(r) ? n.map(r, l).join(", ") : l(r), a = i.getName(t);
                return e ? s(this.name) + " : " + o : s(this.name) + "<br />" + (a ? s(a) + " : " + o : o)
            },
            restoreData: function () {
        ...
        (function (e) {
            ...
            var o = "undefined", a = "undefined" == typeof window ? e : window, s = typeof a.Float64Array === o ? Array : a.Float64Array, l = typeof a.Int32Array === o ? Array : a.Int32Array, h = {
                ...
                number: Array,
                time: Array
            }, c = i(12), u = i(52), d = i(1), f = i(7), p = d.isObject, g = ["stackedOn", "_nameList", "_idList", "_rawData"], m = function (t, e, i) {
            ...
            y.type = "list", y.getDimension = function (t) {
                ...
                return t = this.indices[t], new c(this._rawData[t], e, e.ecModel)
            }, y.diff = function (t) {
        ...
        function s(t, e, i, r, o, a) {
            ...
            if (n(u) && n(d))if (n(l))a[0] = 0; else {
                ...
                if (n(m)) {
                    ...
                    var x = b(m), w = u * l + 1.5 * s * (-d + x), A = u * l + 1.5 * s * (-d - x);
                    w = 0 > w ? -_(-w, S) : _(w, S), A = 0 > A ? -_(-A, S) : _(A, S);
                    var g = (-l - (w + A)) / (3 * s);
                    g >= 0 && 1 >= g && (a[p++] = g)
                } else {
                    var T = (2 * u * l - 3 * s * d) / (2 * b(u * u * u)), C = Math.acos(T) / 3, I = b(u), k = Math.cos(C), g = (-l - 2 * I * k) / (3 * s), y = (-l + I * (k + M * Math.sin(C))) / (3 * s), D = (-l + I * (k - M * Math.sin(C))) / (3 * s);
        ...
        function c(t, e, i, n, r, a, s, l, h, c, u) {
            ...
            A[0] = h, A[1] = c;
            for (var _ = 0; 1 > _; _ += .05)T[0] = o(t, i, r, s, _), T[1] = o(e, n, a, l, _), g = x(A, T), y > g && (d = _, y = g);
            y = 1 / 0;
            for (var M = 0; 32 > M && !(w > v); M++)f = d - v, p = d + v, T[0] = o(t, i, r, s, f), T[1] = o(e, n, a, l, f), g = x(T, A), f >= 0 && y > g ? (d = f, y = g) : (C[0] = o(t, i, r, s, p), C[1] = o(e, n, a, l, p), m = x(C, A), 1 >= p && y > m ? (d = p, y = m) : v *= .5);
        ...
        function m(t, e, i, n, r, o, a, s, l) {
            ...
            for (var f = 0; 1 > f; f += .05) {
                T[0] = u(t, i, r, f), T[1] = u(e, n, o, f);
                var p = x(A, T);
                d > p && (h = f, d = p)
            }
            d = 1 / 0;
            for (var g = 0; 32 > g && !(w > c); g++) {
                var m = h - c, v = h + c;
                T[0] = u(t, i, r, m), T[1] = u(e, n, o, m);
                var p = x(T, A);
                if (m >= 0 && d > p)h = m, d = p; else {
                    C[0] = u(t, i, r, v), C[1] = u(e, n, o, v);
                    var y = x(C, A);
                    1 >= v && d > y ? (h = v, d = y) : c *= .5
                }
            }
        ...
        var v = i(5), y = v.create, x = v.distSquare, _ = Math.pow, b = Math.sqrt, w = 1e-4, M = b(3), S = 1 / 3, A = y(), T = y(), C = y();
        t.exports = {
            cubicAt: o,
            cubicDerivativeAt: a,
            cubicRootAt: s,
        ...
        a.enableClassExtend = function (t, e) {
            ...
            if (t.registerClass = function (t, e) {
                    ...
                    var r = n[t];
                    if (r && r[l] && (r = e ? r[e] : null), i && !r)throw new Error("Component " + t + "." + (e || "") + " not exists");
                    return r
        ...
        function g(t, e, n) {
            if (e && e.length && t >= 0 && 1 >= t) {
                var o = t * (e.length - 1), a = Math.floor(o), s = Math.ceil(o), c = h(e[a]), u = h(e[s]), d = o - a, f = x([i(l(c[0], u[0], d)), i(l(c[1], u[1], d)), i(l(c[2], u[2], d)), r(l(c[3], u[3], d))], "rgba");
        ...
        function m(t, e) {
            if (!(2 !== t.length || t[1] < t[0])) {
                for (var i = g(t[0], e, !0), n = g(t[1], e, !0), r = [{
                    color: i.color,
                    offset: 0
        ...
        function v(t, e, i, r) {
            return t = h(t), t ? (t = u(t), null != e && (t[0] = n(e)), null != i && (t[1] = a(i)), null != r && (t[2] = a(r)), x(c(t), "rgba")) : void 0
        }

        function y(t, e) {
            return t = h(t), t && null != e ? (t[3] = r(e), x(t, "rgba")) : void 0
        }
        ...
        h.getScaleExtent = function (t, e) {
            ...
            var i = t.scale, n = h.getScaleExtent(t, e), r = null != e.get("min"), o = null != e.get("max");
            i.setExtent(n[0], n[1]), i.niceExtent(e.get("splitNumber"), r, o);
        ...
        a.prototype = {
            constructor: a, type: "group", children: function () {
        ...
        "use strict";
        var n = i(18), r = i(5), o = i(64), a = i(8), s = {
            M: 1,
            L: 2,
            C: 3,
            Q: 4,
            ...
            Z: 6,
            R: 7
        }, l = [], h = [], c = [], u = [], d = Math.min, f = Math.max, p = Math.cos, g = Math.sin, m = Math.sqrt, v = "undefined" != typeof Float32Array, y = function () {
        ...
        y.prototype = {
            constructor: y, _lineDash: null, _dashOffset: 0, _dashIdx: 0, _dashSum: 0, getContext: function () {
                ...
                return this.addData(s.C, t, e, i, n, r, o), this._ctx && (this._needsDash() ? this._dashedBezierTo(t, e, i, n, r, o) : this._ctx.bezierCurveTo(t, e, i, n, r, o)), this._xi = r, this._yi = o, this
                ...
                return this.addData(s.A, t, e, i, i, n, r - n, 0, o ? 0 : 1), this._ctx && this._ctx.arc(t, e, i, n, r, o), this._xi = p(r) * i + t, this._xi = g(r) * i + t, this
                ...
                var i, n, r = this._dashSum, o = this._dashOffset, a = this._lineDash, s = this._ctx, l = this._xi, h = this._yi, c = t - l, u = e - h, p = m(c * c + u * u), g = l, v = h, y = a.length;
                for (c /= p, u /= p, 0 > o && (o = r + o), o %= r, g -= o * c, v -= o * u; c >= 0 && t >= g || 0 > c && g > t;)n = this._dashIdx, i = a[n], g += c * i, v += u * i, this._dashIdx = (n + 1) % y, c > 0 && l > g || 0 > c && g > l || s[n % 2 ? "moveTo" : "lineTo"](c >= 0 ? d(g, t) : f(g, t), u >= 0 ? d(v, e) : f(v, e));
                c = g - t, u = v - e, this._dashOffset = -m(c * c + u * u)
            }, _dashedBezierTo: function (t, e, i, r, o, a) {
                var s, l, h, c, u, d = this._dashSum, f = this._dashOffset, p = this._lineDash, g = this._ctx, v = this._xi, y = this._yi, x = n.cubicAt, _ = 0, b = this._dashIdx, w = p.length, M = 0;
                for (0 > f && (f = d + f), f %= d, s = 0; 1 > s; s += .1)l = x(v, t, i, o, s + .1) - x(v, t, i, o, s), h = x(y, e, r, a, s + .1) - x(y, e, r, a, s), _ += m(l * l + h * h);
                for (; w > b && (M += p[b], !(M > f)); b++);
                for (s = (M - f) / _; 1 >= s;)c = x(v, t, i, o, s), u = x(y, e, r, a, s), b % 2 ? g.moveTo(c, u) : g.lineTo(c, u), s += p[b] / _, b = (b + 1) % w;
                b % 2 !== 0 && g.lineTo(o, a), l = o - c, h = a - u, this._dashOffset = -m(l * l + h * h)
                ...
                l[0] = l[1] = c[0] = c[1] = Number.MAX_VALUE, h[0] = h[1] = u[0] = u[1] = -Number.MAX_VALUE;
                for (var t = this.data, e = 0, i = 0, n = 0, d = 0, f = 0; f < t.length;) {
                    var m = t[f++];
                    switch (1 == f && (e = t[f], i = t[f + 1], n = e, d = i), m) {
                        case s.M:
                            n = t[f++], d = t[f++], e = n, i = d, c[0] = n, c[1] = d, u[0] = n, u[1] = d;
                            break;
                        case s.L:
                            o.fromLine(e, i, t[f], t[f + 1], c, u), e = t[f++], i = t[f++];
                            break;
                        case s.C:
                            o.fromCubic(e, i, t[f++], t[f++], t[f++], t[f++], t[f], t[f + 1], c, u), e = t[f++], i = t[f++];
                            break;
                        case s.Q:
                            o.fromQuadratic(e, i, t[f++], t[f++], t[f], t[f + 1], c, u), e = t[f++], i = t[f++];
                            break;
                        case s.A:
                            var v = t[f++], y = t[f++], x = t[f++], _ = t[f++], b = t[f++], w = t[f++] + b, M = (t[f++], 1 - t[f++]);
                            1 == f && (n = p(b) * x + v, d = g(b) * _ + y), o.fromArc(v, y, x, _, b, w, M, c, u), e = p(w) * x + v, i = g(w) * _ + y;
                            break;
                        case s.R:
                            n = e = t[f++], d = i = t[f++];
                            var S = t[f++], A = t[f++];
                ...
                return 0 === f && (l[0] = l[1] = h[0] = h[1] = 0), new a(l[0], l[1], h[0] - l[0], h[1] - l[1])
                ...
                for (var e = this.data, i = 0; i < this._len;) {
                    ...
                    switch (n) {
                        ...
                        case s.Q:
                            ...
                            break;
                        case s.A:
                            var r = e[i++], o = e[i++], a = e[i++], l = e[i++], h = e[i++], c = e[i++], u = e[i++], d = e[i++], f = a > l ? a : l, p = a > l ? 1 : a / l, g = a > l ? l / a : 1, m = Math.abs(a - l) > .001;
                            m ? (t.translate(r, o), t.rotate(u), t.scale(p, g), t.arc(0, 0, f, h, h + c, 1 - d), t.scale(1 / p, 1 / g), t.rotate(-u), t.translate(-r, -o)) : t.arc(r, o, f, h, h + c, 1 - d);
                            break;
                        case s.R:
        ...
        var r = i(1), o = i(141), a = i(55), s = i(66);
        n.prototype = {
            constructor: n,
            type: "displayable",
            __dirty: !0,
        ...
        function o(t, e, i) {
            t = t || [];
            var n = e.get("coordinateSystem"), o = m[n], a = f.get(n), s = o && o(t, e, i), u = s && s.dimensions;
            u || (u = a && a.dimensions || ["x", "y"], u = c(u, t, u.concat(["value"])));
            var d = s && s.categoryAxisModel, v = "ordinal" === u[0].type ? 0 : "ordinal" === u[1].type ? 1 : -1, y = new h(u, e), x = l(s, t), _ = d && r(t) ? function (t, e, i, n) {
                return n === v ? i : g(p(t), u[n])
            } : function (t, e, i, n) {
                var r = p(t);
                return g(r && r[n], u[n])
            };
        ...
        var h = i(14), c = i(31), u = i(1), d = i(7), f = i(28), p = d.getDataItemValue, g = d.converDataValue, m = {
            cartesian2d: function (t, e, i) {
                var n = i.getComponent("xAxis", e.get("xAxisIndex")), r = i.getComponent("yAxis", e.get("yAxisIndex")), o = n.get("type"), l = r.get("type"), h = [{
                    name: "x",
                    type: s(o),
                    stackable: a(o)
                ...
                return c(h, t, ["x", "y", "z"]), {
                    dimensions: h,
                    categoryAxisModel: "category" === o ? n : "category" === l ? r : null
                }
                ...
                return c(d, t, ["radius", "angle", "value"]), {
                    dimensions: d,
                    categoryAxisModel: "category" === u ? o : "category" === h ? l : null
                }
            }, geo: function (t, e, i) {
        ...
        var o = i(1), a = i(15), s = i(2), l = i(7), h = i(166), c = o.each, u = l.eachAxisDim, d = s.extendComponentModel({
            type: "dataZoom",
        ...
        var n = i(35), r = i(8), o = i(1), a = i(60), s = i(139), l = new s(50), h = function (t) {
            n.call(this, t)
        };
        h.prototype = {
            constructor: h, type: "image", brush: function (t) {
                ...
                if (e) {
                    var o = i.width || e.width, s = i.height || e.height, h = i.x || 0, c = i.y || 0;
                    ...
                    if (t.save(), i.bind(t), this.setTransform(t), i.r && (t.beginPath(), a.buildPath(t, i), t.clip()), i.sWidth && i.sHeight) {
                        ...
                        t.drawImage(e, u, d, i.sWidth, i.sHeight, h, c, o, s)
                    } else if (i.sx && i.sy) {
                        var u = i.sx, d = i.sy, f = o - u, p = s - d;
                        t.drawImage(e, u, d, f, p, h, c, o, s)
                    } else t.drawImage(e, h, c, o, s);
        ...
        var a = i(1), s = i(24), l = i(3), h = i(4), c = r.prototype;
        c._createSymbol = function (t, e, i) {
            ...
            l.initProps(h, {scale: c}, r), this._symbolType = t, this.add(h)
        ...
        c._updateCommon = function (t, e, i) {
            var r = this.childAt(0), o = t.hostModel, s = t.getItemModel(e), c = s.getModel(u), g = t.getItemVisual(e, "color"), m = s.getModel(d).getItemStyle();
            r.rotation = s.getShallow("symbolRotate") * Math.PI / 180 || 0;
            var v = s.getShallow("symbolOffset");
            if (v) {
                var y = r.position;
                y[0] = h.parsePercent(v[0], i[0]), y[1] = h.parsePercent(v[1], i[1])
            }
            r.setColor(g), a.extend(r.style, c.getItemStyle(["color"]));
            for (var x, _ = s.getModel(f), b = s.getModel(p), w = r.style, M = t.dimensions.slice(), S = M.pop(); "ordinal" === (x = t.getDimensionInfo(S).type) || "time" === x;)S = M.pop();
            _.get("show") ? (l.setText(w, _, g), w.text = a.retrieve(o.getFormattedLabel(e, "normal"), t.get(S, e))) : w.text = "", b.getShallow("show") ? (l.setText(m, b, g), m.text = a.retrieve(o.getFormattedLabel(e, "emphasis"), t.get(S, e))) : m.text = "";
            ...
            if (r.off("mouseover").off("mouseout").off("emphasis").off("normal"), l.setHoverStyle(r, m), s.getShallow("hoverAnimation")) {
                ...
                r.on("mouseover", T).on("mouseout", C).on("emphasis", T).on("normal", C)
            }
        ...
        function n(t, e, i) {
            var n, r, o = h(e - t.rotation);
            return c(o) ? (r = i > 0 ? "top" : "bottom", n = "center") : c(o - u) ? (r = i > 0 ? "bottom" : "top", n = "center") : (r = "middle", n = o > 0 && u > o ? i > 0 ? "right" : "left" : i > 0 ? "left" : "right"), {
                rotation: o,
                textAlign: n,
                verticalAlign: r
            }
        ...
        function r(t, e, i) {
            var n, r, o = h(-t.rotation), a = i[0] > i[1], s = "start" === e && !a || "start" !== e && a;
            return c(o - u / 2) ? (r = s ? "bottom" : "top", n = "center") : c(o - 1.5 * u) ? (r = s ? "top" : "bottom", n = "center") : (r = "middle", n = 1.5 * u > o && o > u / 2 ? s ? "left" : "right" : s ? "right" : "left"), {
                rotation: o,
                textAlign: n,
                verticalAlign: r
            }
        ...
        var o = i(1), a = i(3), s = i(12), l = i(4), h = l.remRadian, c = l.isRadianAroundZero, u = Math.PI, d = function (t, e) {
            this.opt = e, this.axisModel = t, o.defaults(e, {
                ...
                labelDirection: 1,
                silent: !0
            }), this.group = new a.Group({position: e.position.slice(), rotation: e.rotation})
        };
        d.prototype = {
        ...
        var f = {
            axisLine: function () {
                ...
                if (t.get("axisTick.show")) {
                    for (var e = t.axis, i = t.getModel("axisTick"), n = this.opt, r = i.getModel("lineStyle"), o = i.get("length"), s = g(i, n.labelInterval), l = e.getTicksCoords(), h = [], c = 0; c < l.length; c++)if (!p(e, c, s)) {
                        var u = l[c];
                        h.push(new a.Line(a.subPixelOptimizeLine({
                            shape: {x1: u, y1: 0, x2: u, y2: n.tickDirection * o},
                            style: {lineWidth: r.get("width")},
                            silent: !0
                        })))
                    }
                    this.group.add(a.mergePath(h, {style: r.getLineStyle(), z2: 2, silent: !0}))
                }
            }, axisLabel: function () {
                function t(t, e) {
                ...
                if (e.get("axisLabel.show")) {
                    var i = this.opt, r = e.axis, o = e.getModel("axisLabel"), l = o.getModel("textStyle"), h = o.get("margin"), c = r.scale.getTicks(), d = e.getFormattedLabels(), f = i.labelRotation;
                    null == f && (f = o.get("rotate") || 0), f = f * u / 180;
                    for (var g = n(i, f, i.labelDirection), m = e.get("data"), v = [], y = 0; y < c.length; y++)if (!p(r, y, i.labelInterval)) {
                        var x = l;
                        m && m[y] && m[y].textStyle && (x = new s(m[y].textStyle, l, e.ecModel));
                        var _ = r.dataToCoord(c[y]), b = [_, i.labelOffset + i.labelDirection * h], w = new a.Text({
                            style: {
                                text: d[y],
                    ...
                    if ("category" !== r.type) {
                        ...
                        if (e.getMax ? e.getMax() : e.get("max")) {
                            var A = v[v.length - 1], T = v[v.length - 2];
                            t(T, A) && (A.ignore = !0)
                        }
                    }
                }
                ...
                if (null == i && (i = e.get("name")), i) {
                    var o, s = e.get("nameLocation"), l = t.nameDirection, h = e.getModel("nameTextStyle"), c = e.get("nameGap") || 0, u = this.axisModel.axis.getExtent(), d = u[0] > u[1] ? -1 : 1, f = ["start" === s ? u[0] - d * c : "end" === s ? u[1] + d * c : (u[0] + u[1]) / 2, "middle" === s ? t.labelOffset + l * c : 0];
                    o = "middle" === s ? n(t, t.rotation, l) : r(t, s, u), this.group.add(new a.Text({
                        style: {
                            text: i,
                            textFont: h.getFont(),
        ...
        var r = i(10), o = i(1), a = i(61), s = r.extend({
        ...
        var s = i(11), l = i(23), h = i(1), c = i(106), u = i(104), d = h.each, f = l.ifAxisCrossZero, p = l.niceScaleExtent;
        i(107);
        var g = o.prototype;
        ...
        }, o.dimensions = c.prototype.dimensions, i(28).register("cartesian2d", o), t.exports = o
    }, function (t, e) {
        "use strict";
        function i(t) {
            return t
        ...
        var n = i(26), r = i(41), o = i(20), a = function () {
        ...
        "use strict";
        var n = i(58), r = i(21), o = i(77), a = i(153), s = i(1), l = function (t) {
        ...
        function p(t, e, i, n, r) {
            ...
            if (x) {
                ...
                for (var T = [], C = [], I = n[0].value, k = !0, D = 0; x > D; D++) {
                    T.push(n[D].time / _);
                    var L = n[D].value;
                    if (w && h(L, I, A) || !w && L === I || (k = !1), I = L, "string" == typeof L) {
                        var P = m.parse(L);
                        P ? (L = P, M = !0) : S = !0
                    }
                    C.push(L)
                ...
                if (!k) {
                    if (w) {
                        for (var z = C[x - 1], D = 0; x - 1 > D; D++)l(C[D], z, A);
                        l(d(t._target, r), z, A)
                    }
                    var O, E, R, B, N, V, F = 0, G = 0;
                    if (M)var Z = [0, 0, 0, 0];
                    var W = function (t, e) {
                        var i;
                        if (G > e) {
                            for (O = Math.min(F + 1, x - 1), i = O; i >= 0 && !(T[i] <= e); i--);
                            i = Math.min(i, x - 2)
                        } else {
                            for (i = F; x > i && !(T[i] > e); i++);
                            i = Math.min(i - 1, x - 2)
                        ...
                        if (0 !== n)if (E = (e - T[i]) / n, v)if (B = C[i], R = C[0 === i ? i : i - 1], N = C[i > x - 2 ? x - 1 : i + 1], V = C[i > x - 3 ? x - 1 : i + 2], w)c(R, B, N, V, E, E * E, E * E * E, d(t, r), A); else {
                            var l;
                            if (M)l = c(R, B, N, V, E, E * E, E * E * E, Z, 1), l = f(Z); else {
                                if (S)return a(B, N, E);
                            ...
                            var l;
                            if (M)s(C[i], C[i + 1], E, Z, 1), l = f(Z); else {
        ...
        var n = i(5), r = i(18), o = {}, a = Math.min, s = Math.max, l = Math.sin, h = Math.cos, c = n.create(), u = n.create(), d = n.create(), f = 2 * Math.PI;
        o.fromPoints = function (t, e, i) {
            ...
            var f, p, g, m, v, y = [], x = [], _ = r.cubicExtrema, b = r.cubicAt, w = _(t, i, o, h, y);
            for (v = 0; w > v; v++)y[v] = b(t, i, o, h, y[v]);
            for (w = _(e, n, l, c, x), v = 0; w > v; v++)x[v] = b(e, n, l, c, x[v]);
            y.push(t, h), x.push(e, c), f = a.apply(null, y), p = s.apply(null, y), g = a.apply(null, x), m = s.apply(null, x), u[0] = f, u[1] = g, d[0] = p, d[1] = m
        ...
        var n = i(35), r = i(1), o = i(17), a = function (t) {
            n.call(this, t)
        };
        a.prototype = {
        ...
        var o = i(17), a = i(8), s = new a, l = function () {
        };
        l.prototype = {
            constructor: l, drawRectText: function (t, e, i) {
                ...
                if (null != l && (l += ""), l) {
                    ...
                    if (v && (s.copy(e), s.applyTransform(v), e = s, r(t, y)), u instanceof Array)h = e.x + n(u[0], e.width), c = e.y + n(u[1], e.height), f = f || "left", g = g || "top"; else {
         ...
         */
        var r = i(58), o = i(15), a = i(126), s = i(129), l = i(130), h = !o.canvasSupported, c = {canvas: i(128)}, u = {}, d = {};
        ...
        t.exports = {
            updateSelectedMap: function () {
                ...
                var e = this._dataOptMap, i = e[t], r = this.get("selectedMode");
        ...
        function l(t, e, i, n) {
            ...
            if (r && r.contain(i, n)) {
                var o = this.target;
                if (o) {
                    var a = o.position, s = o.scale, l = this._zoom = this._zoom || 1;
                    l *= e;
                    var h = l / this._zoom;
                    this._zoom = l, a[0] -= (i - a[0]) * (h - 1), a[1] -= (n - a[1]) * (h - 1), s[0] *= h, s[1] *= h, o.dirty()
                }
        ...
        var c = i(21), u = i(1), d = i(33), f = i(101);
        ...
        "use strict";
        var n = i(1), r = i(16), o = function (t, e, i, n, o) {
        ...
        o.prototype = {
            constructor: o, type: "linear", updateCanvasGradient: function (t, e) {
                for (var i = t.getBoundingRect(), n = this.x * i.width + i.x, r = this.x2 * i.width + i.x, o = this.y * i.height + i.y, a = this.y2 * i.height + i.y, s = e.createLinearGradient(n, o, r, a), l = this.colorStops, h = 0; h < l.length; h++)s.addColorStop(l[h].offset, l[h].color);
            ...
            type: "bar", render: function (t, e, i) {
                ...
                function a(e, i) {
                    ...
                    if (f) {
                        ...
                        c[u] = 0, g[u] = a[u], o[i ? "updateProps" : "initProps"](h, {shape: g}, t)
                    }
                    return h
                }
                ...
                l.diff(h).add(function (t) {
                    ...
                    n(c, u), o.updateProps(r, {shape: c}, t), l.setItemGraphicEl(e, r), s.add(r)
                }).remove(function (e) {
                ...
                e.eachItemGraphicEl(function (a, s) {
                    var l = e.getItemModel(s), h = e.getItemVisual(s, "color"), c = e.getItemLayout(s), u = l.getModel("itemStyle.normal"), d = l.getModel("itemStyle.emphasis").getItemStyle();
                    a.setShape("r", u.get("barBorderRadius") || 0), a.setStyle(r.defaults({fill: h}, u.getBarItemStyle()));
                    var f = i ? c.height > 0 ? "bottom" : "top" : c.width > 0 ? "left" : "right", p = l.getModel("label.normal"), g = l.getModel("label.emphasis"), m = a.style;
                    p.get("show") ? n(m, p, h, r.retrieve(t.getFormattedLabel(s, "normal"), t.getRawValue(s)), f) : m.text = "", g.get("show") ? n(d, g, h, r.retrieve(t.getFormattedLabel(s, "emphasis"), t.getRawValue(s)), f) : d.text = "", o.setHoverStyle(a, d)
                })
            }, remove: function (t, e) {
                var i = this.group;
        ...
        function n(t, e, i) {
            var n = e.getItemVisual(i, "color"), r = e.getItemVisual(i, "symbol"), o = e.getItemVisual(i, "symbolSize");
            if ("none" !== r) {
                p.isArray(o) || (o = [o, o]);
                var a = c.createSymbol(r, -o[0] / 2, -o[1] / 2, o[0], o[1], n);
                return a.name = t, a
            }
        }
        ...
        function s() {
            ...
            if (this.__dirty || e.__dirty) {
                var i = t.childOfName("fromSymbol"), n = t.childOfName("toSymbol"), r = t.childOfName("label"), o = e.pointAt(0), s = e.pointAt(e.shape.percent), h = u.sub([], s, o);
                u.normalize(h, h), i && (i.attr("position", o), a(i) && i.attr("rotation", l(s, o))), n && (n.attr("position", s), a(n) && n.attr("rotation", l(o, s))), r.attr("position", s);
                var c, d, f;
                "end" === r.__position ? (c = [5 * h[0] + s[0], 5 * h[1] + s[1]], d = h[0] > .8 ? "left" : h[0] < -.8 ? "right" : "center", f = h[1] > .8 ? "top" : h[1] < -.8 ? "bottom" : "middle") : (c = [5 * -h[0] + o[0], 5 * -h[1] + o[1]], d = h[0] > .8 ? "right" : h[0] < -.8 ? "left" : "center", f = h[1] > .8 ? "bottom" : h[1] < -.8 ? "top" : "middle"), r.attr({
                    style: {
        ...
        var c = i(24), u = i(5), d = i(161), f = i(3), p = i(1), g = i(4), m = h.prototype;
        m.beforeUpdate = s, m._createLine = function (t, e, i, o) {
            var a = t.hostModel, s = t.getItemLayout(o), l = r(s);
            l.shape.percent = 0, f.initProps(l, {shape: {percent: 1}}, a), this.add(l);
            var h = new f.Text({name: "label"});
            if (this.add(h), e) {
                var c = n("fromSymbol", e, o);
                this.add(c), this._fromSymbolType = e.getItemVisual(o, "symbol")
            }
            if (i) {
                var u = n("toSymbol", i, o);
                this.add(u), this._toSymbolType = i.getItemVisual(o, "symbol")
            }
            this._updateCommonStl(t, e, i, o)
        }, m.updateData = function (t, e, i, r) {
            var a = t.hostModel, s = this.childOfName("line"), l = t.getItemLayout(r), h = {shape: {}};
            if (o(h.shape, l), f.updateProps(s, h, a), e) {
                var c = e.getItemVisual(r, "symbol");
                if (this._fromSymbolType !== c) {
                    var u = n("fromSymbol", e, r);
                    this.remove(this.childOfName("fromSymbol")), this.add(u)
                }
            ...
            var r = t.hostModel, o = this.childOfName("line"), a = t.getItemModel(n), s = a.getModel("label.normal"), l = s.getModel("textStyle"), h = a.getModel("label.emphasis"), c = h.getModel("textStyle"), u = g.round(r.getRawValue(n));
            isNaN(u) && (u = t.getName(n)), o.setStyle(p.extend({stroke: t.getItemVisual(n, "color")}, a.getModel("lineStyle.normal").getLineStyle()));
            var d = this.childOfName("label");
            d.setStyle({
                text: s.get("show") ? p.retrieve(r.getFormattedLabel(n, "normal"), u) : "",
                textFont: l.getFont(),
                fill: l.getTextColor() || t.getItemVisual(n, "color")
            }), d.hoverStyle = {
                text: h.get("show") ? p.retrieve(r.getFormattedLabel(n, "emphasis"), u) : "",
                textFont: l.getFont(),
                fill: c.getTextColor()
            }, d.__textAlign = l.get("align"), d.__verticalAlign = l.get("baseline"), d.__position = s.get("position"), f.setHoverStyle(this, a.getModel("lineStyle.emphasis").getLineStyle())
        }, m.updateLayout = function (t, e, i, n) {
            var r = t.getItemLayout(n), a = this.childOfName("line");
            o(a.shape, r), a.dirty(!0), e && e.getItemGraphicEl(n).attr("position", r[0]), i && i.getItemGraphicEl(n).attr("position", r[1])
        ...
        var r = i(3), o = i(83), a = n.prototype;
        a.updateData = function (t, e, i) {
            var n = this._lineData, r = this.group, o = this._ctor;
        ...
        var n = i(1), r = i(2);
        i(86), i(87), r.registerVisualCoding("chart", n.curry(i(44), "line", "circle", "line")), r.registerLayout(n.curry(i(53), "line")), r.registerProcessor("statistic", n.curry(i(121), "line")), i(34)
    }, function (t, e, i) {
        "use strict";
        var n = i(36), r = i(13);
        t.exports = r.extend({
        ...
        function h(t, e, i) {
            var n = o(t.getAxis("x")), r = o(t.getAxis("y")), a = t.getBaseAxis().isHorizontal(), s = n[0], l = r[0], h = n[1] - s, c = r[1] - l;
            i.get("clipOverflow") || (a ? (l -= c, c *= 3) : (s -= h, h *= 3));
            var u = new m.Rect({shape: {x: s, y: l, width: h, height: c}});
            return e && (u.shape[a ? "width" : "height"] = 0, m.initProps(u, {shape: {width: h, height: c}}, i)), u
        }
        ...
        t.exports = y.extend({
            type: "line", init: function () {
                ...
                A && A.eachItemGraphicEl(function (t, e) {
                    ...
                    points: f,
                    stackedOnPoints: w
                })))) : (M && m.updateData(l, S), v = this._newPolyline(f, o, _), b && (y = this._newPolygon(f, w, o, _)), x.setClipPath(u(o, !0, t))), v.setStyle(d.defaults(h.getLineStyle(), {
                    stroke: l.getVisual("color"),
                    lineJoin: "bevel"
                }));
                var T = t.get("smooth");
                if (T = r(t.get("smooth")), v.setShape({smooth: T, smoothMonotone: t.get("smoothMonotone")}), y) {
                    var C = l.stackedOn, I = 0;
                    if (y.style.opacity = .7, y.setStyle(d.defaults(c.getAreaStyle(), {
                    ...
                    y.setShape({smooth: T, stackedOnSmooth: I, smoothMonotone: t.get("smoothMonotone")})
                }
        ...
        function n(t, e, i, n, r, o, p, g, m, v) {
            for (var y = i, x = 0; r > x; x++) {
                ...
                if (y === i)t[o > 0 ? "moveTo" : "lineTo"](_[0], _[1]), c(d, _); else if (m > 0) {
                    var b = y - o, w = y + o, M = .5, S = e[b], A = e[w];
                    if (o > 0 && (y === r - 1 || isNaN(A[0]) || isNaN(A[1])) || 0 >= o && (0 === y || isNaN(A[0]) || isNaN(A[1])))c(f, _); else {
                        (isNaN(A[0]) || isNaN(A[1])) && (A = _), a.sub(u, A, S);
                        var T, C;
                        if ("x" === v || "y" === v) {
                            var I = "x" === v ? 0 : 1;
                            T = Math.abs(_[I] - S[I]), C = Math.abs(_[I] - A[I])
                        } else T = a.dist(_, S), C = a.dist(_, A);
                        M = C / (C + T), h(f, _, u, -m * (1 - M))
                    }
                    s(d, d, g), l(d, d, p), s(f, f, g), l(f, f, p), t.bezierCurveTo(d[0], d[1], f[0], f[1], _[0], _[1]), h(d, _, u, m * M)
        ...
        var o = i(6), a = i(5), s = a.min, l = a.max, h = a.scaleAndAdd, c = a.copy, u = [], d = [], f = [];
        t.exports = {
            Polyline: o.extend({
                type: "ec-polyline",
                ...
                buildPath: function (t, e) {
                    for (var i = e.points, o = 0, a = i.length, s = r(i, e.smoothConstraint); a > o;)o += n(t, i, o, a, a, 1, s.min, s.max, e.smooth, e.smoothMonotone) + 1
                }
            }),
            Polygon: o.extend({
                type: "ec-polygon",
                ...
                buildPath: function (t, e) {
                    for (var i = e.points, o = e.stackedOnPoints, a = 0, s = i.length, l = e.smoothMonotone, h = r(i, e.smoothConstraint), c = r(o, e.smoothConstraint); s > a;) {
                        var u = n(t, i, a, s, s, 1, h.min, h.max, e.smooth, l);
                        n(t, o, a + u - 1, s, u, -1, c.min, c.max, e.stackedOnSmooth, l), a += u + 1, t.closePath()
                    }
                }
            })
        }
        ...
        i(91), i(92), i(68)("pie", [{
            ...
            event: "pieunselected",
            method: "unSelect"
        }]), r.registerVisualCoding("chart", n.curry(i(63), "pie")), r.registerLayout(n.curry(i(94), "pie")), r.registerProcessor("filter", n.curry(i(62), "pie"))
    }, function (t, e, i) {
        "use strict";
        var n = i(14), r = i(1), o = i(7), a = i(31), s = i(69), l = i(2).extendSeriesModel({
            type: "series.pie",
            init: function (t) {
        ...
        h.updateData = function (t, e, i) {
            ...
            d.label = null, i ? (a.setShape(d), a.shape.endAngle = u.startAngle, s.updateProps(a, {shape: {endAngle: u.endAngle}}, h)) : s.updateProps(a, {shape: d}, h);
            ...
            s.updateProps(i, {shape: {points: h.linePoints || [[h.x, h.y], [h.x, h.y], [h.x, h.y]]}}, r), s.updateProps(n, {
                style: {
                    x: h.x,
                    y: h.y
                }
            ...
            n.setStyle(a(t, e, "normal", u, g)), n.ignore = n.normalIgnore = !u.get("show"), n.hoverIgnore = !d.get("show"), i.ignore = i.normalIgnore = !f.get("show"), i.hoverIgnore = !p.get("show"), i.setStyle({stroke: c}), i.setStyle(f.getModel("lineStyle").getLineStyle()), n.hoverStyle = a(t, e, "emphasis", d, g), i.hoverStyle = p.getModel("lineStyle").getLineStyle();
            var m = f.get("smooth");
        ...
        function n(t, e, i, n, r, o, a) {
            ...
            for (var h, c = 0, u = t.length, d = [], f = [], p = 0; u > p; p++)h = t[p].y - c, 0 > h && s(p, u, -h, r), c = t[p].y + t[p].height;
            0 > a - c && l(u - 1, c - a);
            for (var p = 0; u > p; p++)t[p].y >= i ? f.push(t[p]) : d.push(t[p])
        }

        function r(t, e, i, r, o, a) {
            for (var s = [], l = [], h = 0; h < t.length; h++)t[h].x < e ? s.push(t[h]) : l.push(t[h]);
            n(s, e, i, r, -1, o, a), n(l, e, i, r, 1, o, a);
            for (var h = 0; h < t.length; h++) {
                var c = t[h].linePoints;
                c && (t[h].x < e ? c[2][0] = t[h].x + 3 : c[2][0] = t[h].x - 3, c[1][1] = c[2][1] = t[h].y)
            }
        }
        ...
        t.exports = function (t, e, i, n) {
            ...
            l.each(function (i) {
                ...
                if (a = f.cx, s = f.cy, "center" === m)n = f.cx, r = f.cy, d = "center"; else {
                    var M = "inside" === m || "inner" === m, S = (M ? f.r / 2 * b : f.r * b) + a, A = (M ? f.r / 2 * w : f.r * w) + s;
                    if (y += e - f.r, n = S + 3 * b, r = A + 3 * w, !M) {
                        var T = S + b * y, C = A + w * y, I = T + (0 > b ? -1 : 1) * x, k = C;
                        n = I + (0 > b ? -5 : 5), r = k, u = [[S, A], [T, C], [I, k]]
                    }
                    d = M ? "center" : b > 0 ? "left" : "right"
                }
                var D = g.getModel("textStyle").getFont(), L = g.get("rotate") ? 0 > b ? -_ + Math.PI : -_ : 0, P = t.getFormattedLabel(i, "normal") || l.getName(i), z = o.getBoundingRect(P, D, d, "top");
                c = !!L, f.label = {
                    x: n,
                    y: r,
                    height: z.height,
        ...
        var r = i(1), o = i(3), a = i(48), s = a.ifIgnoreOnTick, l = a.getInterval, h = ["axisLine", "axisLabel", "axisTick", "axisName"], c = ["splitLine", "splitArea"], u = i(2).extendComponentView({
            type: "axis",
            render: function (t, e) {
        ...
        function n(t, e) {
            for (var i in e)_.hasClass(i) || ("object" == typeof e[i] ? t[i] = t[i] ? u.merge(t[i], e[i], !1) : u.clone(e[i]) : t[i] = e[i])
        }
        ...
        n.prototype = {
            constructor: n, setOption: function (t, e) {
                t = f(t, !0);
                var i = this._optionBackup, n = this._newOptionBackup = r.call(this, t, e);
        ...
        var n = i(1), r = i(32), o = i(4), a = i(37), s = r.prototype, l = a.prototype, h = Math.floor, c = Math.ceil, u = Math.pow, d = 10, f = Math.log, p = r.extend({
            type: "log",
            getTicks: function () {
        ...
        var n = i(1), r = i(4), o = i(9), a = i(37), s = a.prototype, l = Math.ceil, h = Math.floor, c = 864e5, u = function (t, e, i, n) {
            for (; n > i;) {
                var r = i + n >>> 1;
                t[r][2] < e ? i = r + 1 : n = r
            }
            ...
            type: "time", getLabel: function (t) {
                ...
                var n = this._extent;
                if (n[0] === n[1] && (n[0] -= c, n[1] += c), n[1] === -(1 / 0) && n[0] === 1 / 0) {
                    var o = new Date;
                    n[1] = new Date(o.getFullYear(), o.getMonth(), o.getDate()), n[0] = n[1] - c
                }
                ...
                t = t || 10;
                var e = this._extent, i = e[1] - e[0], n = i / t, o = f.length, a = u(f, n, 0, o), s = f[Math.min(a, o - 1)], c = s[2];
                if ("year" === s[0]) {
                    var d = i / c, p = r.nice(d / t, !0);
                    c *= p
                }
                var g = [l(e[0] / c) * c, h(e[1] / c) * c];
                this._stepLvl = s, this._interval = c, this._niceExtent = g
            }, parse: function (t) {
        ...
        i.throttle = function (t, e, i, n) {
            function r(r) {
                ...
                var p = function () {
                    l = (new Date).getTime(), a = this, s = arguments, o = l - (n ? h : c) - e, clearTimeout(u), n ? i ? u = setTimeout(f, e) : o >= 0 && f() : o >= 0 ? f() : i && (u = setTimeout(f, -o)), h = l
                };
        ...
        var u = i(15), d = i(33), f = i(1), p = i(154), g = i(138), m = i(21), v = ["click", "dblclick", "mousewheel", "mouseout"];
        ...
        var o = i(1), a = i(42), s = function (t, e, i) {
            var s;
        ...
        var c = i(42), u = i(1), d = i(45), f = i(8), p = i(127), g = new f(0, 0, 0, 0), m = new f(0, 0, 0, 0), v = function (t, e, i) {
        ...
        "use strict";
        var n = i(1), r = i(33).Dispatcher, o = "undefined" != typeof window && (window.requestAnimationFrame || window.msRequestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame) || function (t) {
                setTimeout(t, 16)
            }, a = i(56), s = function (t) {
            ...
            for (var c = 0, p = 0, g = 0, y = 0, x = 0, _ = 0; _ < t.length;) {
                ...
                switch (1 == _ && (p = t[_], g = t[_ + 1], y = p, x = g), b) {
                    ...
                    case h.Q:
                        ...
                        break;
                    case h.A:
                        var w = t[_++], M = t[_++], S = t[_++], A = t[_++], T = t[_++], C = t[_++], I = (t[_++], 1 - t[_++]), k = Math.cos(T) * S + w, D = Math.sin(T) * A + M;
                        _ > 1 ? c += m(p, g, k, D, r, l) : (y = k, x = D);
                        var L = (r - w) * A / S + w;
                        if (i) {
                            if (f.containStroke(w, M, A, T, T + C, I, e, L, l))return !0
                    ...
                    case h.R:
                        ...
                        if (i) {
                            if (v(y, x, k, x, e, r, l) || v(k, x, k, D, e, r, l) || v(k, D, y, D, e, r, l) || v(y, D, k, D, e, r, l))return !0
                        } else c += m(k, x, k, D, r, l), c += m(y, D, y, x, r, l);
                        break;
                    case h.Z:
                        if (i) {
        ...
        var h = i(27).CMD, c = i(135), u = i(134), d = i(137), f = i(133), p = i(57).normalizeRadian, g = i(18), m = i(75), v = c.containStroke, y = 2 * Math.PI, x = 1e-4, _ = [-1, -1, -1], b = [-1, -1];
        t.exports = {
        ...
        "use strict";
        var n = i(1), r = i(16), o = function (t, e, i, n) {
        ...
        o.prototype = {
            constructor: o, type: "radial", updateCanvasGradient: function (t, e) {
                for (var i = t.getBoundingRect(), n = i.width, r = i.height, o = Math.min(n, r), a = this.x * n + i.x, s = this.y * r + i.y, l = this.r * o, h = e.createRadialGradient(a, s, 0, a, s, l), c = this.colorStops, u = 0; u < c.length; u++)h.addColorStop(c[u].offset, c[u].color);
        ...
        "use strict";
        var n = i(18), r = n.quadraticSubdivide, o = n.cubicSubdivide, a = n.quadraticAt, s = n.cubicAt, l = [];
        t.exports = i(6).extend({
            type: "bezier-curve",
            shape: {x1: 0, y1: 0, x2: 0, y2: 0, cpx1: 0, cpy1: 0, percent: 1},
            style: {stroke: "#000", fill: null},
            buildPath: function (t, e) {
                var i = e.x1, n = e.y1, a = e.x2, s = e.y2, h = e.cpx1, c = e.cpy1, u = e.cpx2, d = e.cpy2, f = e.percent;
                0 !== f && (t.moveTo(i, n), null == u || null == d ? (1 > f && (r(i, h, a, f, l), h = l[1], a = l[2], r(n, c, s, f, l), c = l[1], s = l[2]), t.quadraticCurveTo(h, c, a, s)) : (1 > f && (o(i, h, u, a, f, l), h = l[1], u = l[2], a = l[3], o(n, c, d, s, f, l), c = l[1], d = l[2], s = l[3]), t.bezierCurveTo(h, c, u, d, a, s)))
            },
            pointAt: function (t) {
                var e = this.shape, i = e.cpx2, n = e.cpy2;
                return null === i || null === n ? [a(e.x1, e.cpx1, e.x2, t), a(e.y1, e.cpy1, e.y2, t)] : [s(e.x1, e.cpx1, e.cpx1, e.x2, t), s(e.y1, e.cpy1, e.cpy1, e.y2, t)]
            }
        })
    }, function (t, e, i) {
        "use strict";
        ...
        t.exports = i(6).extend({
            ...
            buildPath: function (t, e) {
                ...
                t.moveTo(h * r + i, c * r + n), t.lineTo(h * o + i, c * o + n), t.arc(i, n, o, a, s, !l), t.lineTo(Math.cos(s) * r + i, Math.sin(s) * r + n), 0 !== r && t.arc(i, n, r, s, a, l), t.closePath()
            }
        })
    }, function (t, e, i) {
        "use strict";
        ...
        var a = i(6), s = i(27), l = i(156), h = i(19), c = ["m", "M", "l", "L", "v", "V", "h", "H", "z", "Z", "c", "C", "q", "Q", "t", "T", "s", "S", "a", "A"], u = Math.sqrt, d = Math.sin, f = Math.cos, p = Math.PI, g = function (t) {
        ...
        var r = i(27).CMD, o = i(5), a = o.applyTransform, s = [[], [], []], l = Math.sqrt, h = Math.atan2;
        t.exports = n
    }, function (t, e, i) {
        ...
        var r = i(3), o = i(24), a = i(1), s = r.extendShape({
        ...
        var n = i(3), r = n.Line.prototype, o = n.BezierCurve.prototype;
        t.exports = n.extendShape({
            ...
            pointAt: function (t) {
                var e = this.shape;
                return null == e.cpx1 || null == e.cpy1 ? r.pointAt.call(this, t) : o.pointAt.call(this, t)
            }
        })
    }, function (t, e, i) {
        var n = i(1), r = i(2);
        i(163), i(164), r.registerVisualCoding("chart", n.curry(i(44), "scatter", "circle", null)), r.registerLayout(n.curry(i(53), "scatter")), i(34)
    }, function (t, e, i) {
        "use strict";
        var n = i(36), r = i(13);
        t.exports = r.extend({
        ...
        function r(t, e, i) {
            ...
            return e = e.slice(), o(e, n, r), h(["startValue", "endValue"], function (e) {
                ...
                var i = u[t], n = s[t];
                null != n || null == i ? (null == n && (n = a[t]), i = r.parse(l.linearMap(n, a, e, !0))) : n = l.linearMap(i, e, a, !0), u[t] = l.round(i), s[t] = l.round(n)
        ...
        var s = i(40), l = i(1), h = i(71), c = i(173), u = l.bind, d = s.extend({
            type: "dataZoom.inside",
            init: function (t, e) {
                this._range
            },
            render: function (t, e, i, n) {
                d.superApply(this, "render", arguments), c.shouldRecordRange(n, t.id) && (this._range = t.getPercentRange()), l.each(this.getTargetInfo().cartesians, function (e) {
                    var n = e.model;
                    c.register(i, {
                        coordId: n.id,
                        coordType: n.type,
            ...
            _onZoom: function (t, e, i, n, o) {
                ...
                if (!a.option.zoomLock)return this._range = r(1 / i, [n, o], this._range, e, t, a)
            }
        });
        t.exports = d
    }, function (t, e, i) {
        ...
        var n = i(39), r = (i(11), i(1)), o = n.extend({
            ...
            setDefaultLayoutParams: function (t) {
                var e = this.option;
                r.each(["right", "top", "width", "height"], function (i) {
                    "ph" === e[i] && (e[i] = t[i])
                })
            },
            mergeOption: function (t) {
        ...
        var r = i(1), o = i(3), a = i(125), s = i(40), l = o.Rect, h = i(4), c = h.linearMap, u = i(11), d = i(71), f = h.asc, p = r.bind, g = Math.round, m = Math.max, v = r.each, y = 7, x = 1, _ = 30, b = "horizontal", w = "vertical", M = 5, S = ["line", "bar", "candlestick", "scatter"], A = s.extend({
            type: "dataZoom.slider",
            init: function (t, e) {
            ...
            _resetLocation: function () {
                ...
                t.setDefaultLayoutParams(r);
                var o = u.getLayoutRect(t.option, n, t.padding);
                this._location = {
                    x: o.x,
                    y: o.y
                }, this._size = [o.width, o.height], this._orient === w && this._size.reverse()
            },
        ...
        function r(t, e, i) {
            var n = new u(t.getZr());
            return n.enable(), n.on("pan", f(a, i)), n.on("zoom", f(s, i)), n.rect = e.coordinateSystem.getRect().clone(), n
        }
        ...
        var c = i(1), u = i(70), d = i(125), f = c.curry, p = "\x00_ec_dataZoom_roams", g = {
            register: function (t, e) {
                var i = n(t), a = e.dataZoomId, s = e.coordType + "\x00_" + e.coordId;
                c.each(i, function (t, e) {
                    var i = t.dataZoomInfos;
                    i[a] && e !== s && (delete i[a], t.count--)
                }), o(i);
                var l = i[s];
                l || (l = i[s] = {
                    coordId: s,
                    dataZoomInfos: {},
                    count: 0
                }, l.controller = r(t, e, l), l.dispatchAction = c.curry(h, t)), l && (d.createOrUpdate(l, "dispatchAction", e.throttleRate, "fixRate"), !l.dataZoomInfos[a] && l.count++, l.dataZoomInfos[a] = e)
        ...
        var a = i(1), s = i(24), l = i(3), h = i(102), c = a.curry, u = "#ccc";
                ...
                if (s.removeAll(), t.get("show")) {
                    ...
                    a.each(t.getData(), function (a) {
                        ...
                        if (f[h] = a, g && !p[h]) {
                            ...
                            var y = m.getVisual("legendSymbol") || "roundRect", x = m.getVisual("symbol"), _ = this._createItem(h, a, t, y, x, d, v, u);
                            _.on("click", c(n, h, i)).on("mouseover", c(r, g, "", i)).on("mouseout", c(o, g, "", i)), p[h] = !0
                        }
                        ...
                        if (e.legendDataProvider) {
                            ...
                            a.each(function (s) {
                                var l = a.getName(s);
                                if (f[l] && !p[l]) {
                                    var h = a.getItemVisual(s, "color"), g = "roundRect", m = this._createItem(l, f[l], t, g, null, d, h, u);
                                    m.on("click", c(n, l, i)).on("mouseover", c(r, e, l, i)).on("mouseout", c(o, e, l, i)), p[l] = !0
                                }
                            }, !1, this)
                        }
        ...
        var n = i(7), r = i(2).extendComponentModel({
            type: "markLine",
            ...
            mergeOption: function (t, e, i, o) {
                i || e.eachSeries(function (t) {
                    var i = t.get("markLine"), a = t.markLineModel;
                    if (!i || !i.data)return void(t.markLineModel = null);
                    if (a)a.mergeOption(i, e, !0); else {
        ...
        function r(t, e, i) {
            var r = o.map(t.dimensions, function (t) {
                var i = e.getData().getDimensionInfo(e.coordDimToDataDim(t)[0]);
                return i.name = t, i
            }), s = new a(r, i), l = new a(r, i), h = new a([], i);
            if (t) {
                var c = o.filter(o.map(i.get("data"), o.curry(p, e, t, i)), o.curry(n, t));
                s.initData(o.map(c, function (t) {
                    return t[0]
                }), null, d.dimValueGetter), l.initData(o.map(c, function (t) {
                    return t[1]
                }), null, d.dimValueGetter), h.initData(o.map(c, function (t) {
                    return t[2]
                }))
            }
        ...
        var o = i(1), a = i(14), s = i(9), l = i(7), h = i(4), c = s.addCommas, u = s.encodeHTML, d = i(103), f = i(84), p = function (t, e, i, n) {
            var r = t.getData(), a = n.type;
            if (!o.isArray(n) && ("min" === a || "max" === a || "average" === a)) {
                var s = d.getAxisInfo(n, r, e, t), l = s.baseAxis.dim + "Axis", h = s.valueAxis.dim + "Axis", c = s.baseAxis.scale.getExtent(), u = o.clone(n), f = {};
                u.type = null, u[l] = c[0], f[l] = c[1];
                var p = d.numCalculate(r, s.valueDataDim, a);
                p = s.valueAxis.coordToData(s.valueAxis.dataToCoord(p));
                var g = i.get("precision");
                g >= 0 && (p = +p.toFixed(g)), u[h] = f[h] = p, n = [u, f, {
                    type: a,
            ...
            formatTooltip: function (t) {
                var e = this._data, i = this.getRawValue(t), n = o.isArray(i) ? o.map(i, c).join(", ") : c(i), r = e.getName(t);
        ...
        o.defaults(g, l.dataFormatMixin), i(2).extendComponentView({
            type: "markLine", init: function () {
                ...
                function a(e, i, r, o, a) {
                    var l, u = e.getItemModel(i), d = u.get("x"), f = u.get("y");
                    if (null != d && null != f)l = [h.parsePercent(d, n.getWidth()), h.parsePercent(f, n.getHeight())]; else {
                        ...
                        if (o && "cartesian2d" === s.type) {
                            var v = null != a ? s.getAxis(1 === a ? "x" : "y") : s.getAxesByScale("ordinal")[0];
                            v && v.onBand && (l["x" === v.dim ? 0 : 1] = v.toGlobalCoord(v.getExtent()[r ? 0 : 1]))
                        }
                    }
                    e.setItemLayout(i, l), e.setItemVisual(i, {
                        symbolSize: u.get("symbolSize") || b[r ? 0 : 1],
                        symbol: u.get("symbol", !0) || _[r ? 0 : 1],
                        color: u.get("itemStyle.normal.color") || c.getVisual("color")
                    })
                }

                var s = t.coordinateSystem, l = t.name, c = t.getData(), u = this._markLineMap, d = u[l];
                d || (d = u[l] = new f), this.group.add(d.group);
                var p = r(s, t, e), m = s.dimensions, v = p.from, y = p.to, x = p.line;
                o.extend(e, g), e.setData(x);
                var _ = e.get("symbol"), b = e.get("symbolSize");
                o.isArray(_) || (_ = [_, _]), "number" == typeof b && (b = [b, b]), p.from.each(function (t) {
                    var e = x.getItemModel(t), i = e.get("type"), n = e.get("valueIndex");
                    a(v, t, !0, i, n), a(y, t, !1, i, n)
                }), x.each(function (t) {
        ...
        var n = i(7), r = i(2).extendComponentModel({
            ...
            mergeOption: function (t, e, i, o) {
                i || e.eachSeries(function (t) {
                    var i = t.get("markPoint"), a = t.markPointModel;
        ...
        function n(t, e, i) {
            ...
            return t && r.initData(o.filter(o.map(i.get("data"), o.curry(d.dataTransform, e)), o.curry(d.dataFilter, t)), null, d.dimValueGetter), r
        }

        var r = i(38), o = i(1), a = i(9), s = i(7), l = i(4), h = a.addCommas, c = a.encodeHTML, u = i(14), d = i(103), f = {
            getRawDataArray: function () {
                return this.option.data
            }, formatTooltip: function (t) {
                var e = this.getData(), i = this.getRawValue(t), n = o.isArray(i) ? o.map(i, h).join(", ") : h(i), r = e.getName(t);
                return this.name + "<br />" + ((r ? c(r) + " : " : "") + n)
            }, getData: function () {
                return this._data
            }, setData: function (t) {
                this._data = t
        ...
        o.defaults(f, s.dataFormatMixin), i(2).extendComponentView({
            type: "markPoint", init: function () {
                ...
                var a = t.coordinateSystem, s = t.name, h = t.getData(), c = this._symbolDrawMap, u = c[s];
                u || (u = c[s] = new r);
                var d = n(a, t, e), p = a && a.dimensions;
                o.mixin(e, f), e.setData(d), d.each(function (n) {
                    var r, o = d.getItemModel(n), s = o.getShallow("x"), c = o.getShallow("y");
                    if (null != s && null != c)r = [l.parsePercent(s, i.getWidth()), l.parsePercent(c, i.getHeight())]; else if (t.getMarkerPosition)r = t.getMarkerPosition(d.getValues(d.dimensions, n)); else if (a) {
                        var u = d.get(p[0], n), f = d.get(p[1], n);
                        r = a.dataToPoint([u, f])
                    }
                    d.setItemLayout(n, r);
        ...
        (function (e) {
            ...
            var r = i(29), o = i(1), a = i(3), s = i(12), l = i(52), h = i(102), c = i(17);
            t.exports = i(2).extendComponentView({
        ...
        d.defaultOption = {
            ...
            h.style.cssText = "display:block;width:100%;font-size:14px;line-height:1.6rem;font-family:Monaco,Consolas,Courier new,monospace", h.readOnly = r.get("readOnly"), h.style.color = r.get("textColor"), h.style.borderColor = r.get("textareaBorderColor"), h.style.backgroundColor = r.get("textareaColor");
            var c = a(t);
            h.value = c.value;
            var d = c.meta, f = document.createElement("div");
            ...
            p += ";background-color:" + r.get("buttonColor"), p += ";color:" + r.get("buttonTextColor");
            var x = this;
        ...
        var h = i(1), c = i(4), u = i(159), d = i(8), f = i(26), p = i(99), g = i(101), m = h.each, v = c.asc;
        i(174);
        ...
        var l = i(1), h = i(22), c = i(33), u = i(9), d = l.each, f = u.toCamelCase, p = ["", "-webkit-", "-moz-", "-o-"], g = "position:absolute;display:block;border-style:solid;white-space:nowrap;";
        a.prototype = {
        ...
        function h(t, e, i, n, r, o, a) {
            ...
            if (o && u.applyTransform(o.transform), "function" == typeof t && (t = t([e, i], r, u)), f.isArray(t))e = m(t[0], h), i = m(t[1], c); else if ("string" == typeof t && o) {
                var d = l(t, u, n.el);
                e = d[0], i = d[1]
            } else {
        ...
        var u = i(196), d = i(3), f = i(1), p = i(9), g = i(4), m = g.parsePercent, v = i(15);
        i(2).extendComponentView({
            type: "tooltip", _axisPointers: {}, init: function (t, e) {
                ...
                if (!v.node) {
                    ...
                    var a = this._api.getZr(), s = this._tryShow;
                    a.off("click", s), a.off("mousemove", s), a.off("mouseout", this._hide), "click" === t.get("triggerOn") ? a.on("click", s, this) : (a.on("mousemove", s, this), a.on("mouseout", this._hide, this))
                }
                ...
                if (t.from !== this.uid) {
                    ...
                    if (null == t.x || null == t.y) {
                        if (r || e.eachSeries(function (t) {
                            ...
                            if (u && u.dataToPoint) {
                                var d = u.dataToPoint(a.getValues(u.dimensions, n, !0));
                                s = d && d[0], l = d && d[1]
                            } else if (h) {
                ...
                if (i)if (this._lastX = t.offsetX, this._lastY = t.offsetY, e && null != e.dataIndex) {
                    var a = e.hostModel || r.getSeriesByIndex(e.seriesIndex), s = e.dataIndex, l = a.getData().getItemModel(s);
                ...
                if ("cross" === h)o("angle", n, u.getExtent()), o("radius", n, c.getExtent()),
                    this._updateCrossText(e, n, t); else {
                ...
                var n = this._api, r = t.getData(), o = r.getItemModel(e), a = this._tooltipModel, s = this._tooltipContent, l = o.getModel("tooltip");
                if (l.parentModel ? l.parentModel.parentModel = a : l.parentModel = this._tooltipModel, l.get("showContent")) {
                    var c, u = l.get("formatter"), d = l.get("position"), f = t.getDataParams(e);
                    if (u) {
                        if ("string" == typeof u)c = p.formatTpl(u, f); else if ("function" == typeof u) {
                    ...
                    s.show(l), s.setContent(c), h(d, i.offsetX, i.offsetY, s, f, i.target, n)
                }
        ...
        if (!i(15).canvasSupported) {
            var n = i(5), r = i(8), o = i(27).CMD, a = i(22), s = i(17), l = i(66), h = i(35), c = i(46), u = i(65), d = i(6), f = i(16), p = i(157), g = Math.round, m = Math.sqrt, v = Math.abs, y = Math.cos, x = Math.sin, _ = Math.max, b = n.applyTransform, w = ",", M = "progid:DXImageTransform.Microsoft", S = 21600, A = S / 2, T = 1e5, C = 1e3, I = function (t) {
                ...
                if (null != n)if (n instanceof f) {
                    ...
                    for (var T = A.length, C = [], I = [], k = 0; T > k; k++) {
                        var D = A[k], L = R(D.color);
                        I.push(D.offset * l + s + " " + L[0]), 0 !== k && k !== T - 1 || C.push(L)
                    }
                    if (T >= 2) {
                        var P = C[0][0], z = C[1][0], O = C[0][1] * e.opacity, B = C[1][1] * e.opacity;
                        t.type = r, t.method = "none", t.focus = "100%", t.angle = o, t.color = P, t.color2 = z, t.colors = I.join(","), t.opacity = B, t.opacity2 = O
                    }
                ...
                null != i[e] && "none" !== i[e] && (r || !r && i.lineWidth) ? (t[r ? "filled" : "stroked"] = "true", i[e]instanceof f && P(t, o), o || (o = p.createNode(e)), r ? B(o, i, n) : N(o, i), L(t, o)) : (t[r ? "filled" : "stroked"] = "false", P(t, o))
            }, F = [[], [], []], G = function (t, e) {
                ...
                for (a = 0; a < t.length;) {
                    switch (r = t[a++], n = "", i = 0, r) {
                        ...
                        case c:
                            ...
                            break;
                        case d:
                            var k = 0, D = 0, L = 1, P = 1, z = 0;
                            e && (k = e[4], D = e[5], L = m(e[0] * e[0] + e[1] * e[1]), P = m(e[2] * e[2] + e[3] * e[3]), z = Math.atan2(-e[1] / P, e[0] / L));
                            var O = t[a++], E = t[a++], R = t[a++], B = t[a++], N = t[a++] + z, V = t[a++] + N + z;
                            a++;
                            var G = t[a++], Z = O + y(N) * R, W = E + x(N) * B, M = O + y(V) * R, T = E + x(V) * B, H = G ? " wa " : " at ";
                            p.push(H, g(((O - R) * L + k) * S - A), w, g(((E - B) * P + D) * S - A), w, g(((O + R) * L + k) * S - A), w, g(((E + B) * P + D) * S - A), w, g((Z * L + k) * S - A), w, g((W * P + D) * S - A), w, g((M * L + k) * S - A), w, g((T * P + D) * S - A)), s = M, l = T;
                            break;
                        case o.R:
                            var q = F[0], j = F[1];
            ...
            d.prototype.brush = function (t) {
                ...
                var l = this.path;
                this.__dirtyPath && (l.beginPath(), this.buildPath(l, this.shape), this.__dirtyPath = !1), i.path = G(l.data, this.transform), i.style.zIndex = z(this.zlevel, this.z, this.z2), L(t, i), e.text && this.drawRectText(t, this.getBoundingRect())
            ...
            c.prototype.brush = function (t) {
                ...
                if (r) {
                    ...
                    var T, C = A.style, k = !1, D = 1, P = 1;
                    if (this.transform && (T = this.transform, D = m(T[0] * T[0] + T[1] * T[1]), P = m(T[2] * T[2] + T[3] * T[3]), k = T[1] || T[2]), k) {
                        var O = [h, c], E = [h + u, c], R = [h, c + d], B = [h + u, c + d];
                        b(O, O, T), b(E, E, T), b(R, R, T), b(B, B, T);
                        var N = _(O[0], E[0], R[0], B[0]), V = _(O[1], E[1], R[1], B[1]), F = [];
                        F.push("M11=", T[0] / D, w, "M12=", T[2] / P, w, "M21=", T[1] / D, w, "M22=", T[3] / P, w, "Dx=", g(h * D + T[4]), w, "Dy=", g(c * P + T[5])), C.padding = "0 " + g(N) + "px " + g(V) + "px 0", C.filter = M + ".Matrix(" + F.join("") + ", SizingMethod=clip)"
                    } else T && (h = h * D + T[4], c = c * P + T[5]), C.filter = "", C.left = g(h) + "px", C.top = g(c) + "px";
                    var G = this._imageEl, W = this._cropEl;
                    G || (G = p.doc.createElement("div"), this._imageEl = G);
                    var H = G.style;
                    if (S) {
                        if (e && i)H.width = g(D * e * u / f) + "px", H.height = g(P * i * d / v) + "px"; else {
                            var q = new Image, j = this;
                            q.onload = function () {
                                q.onload = null, e = q.width, i = q.height, H.width = g(D * e * u / f) + "px", H.height = g(P * i * d / v) + "px", j._imageWidth = e, j._imageHeight = i, j._imageSrc = r
                            }, q.src = r
                        }
                        W || (W = p.doc.createElement("div"), W.style.overflow = "hidden", this._cropEl = W);
                        var X = W.style;
                        X.width = g((u + y * u / f) * D), X.height = g((d + x * d / v) * P), X.filter = M + ".Matrix(Dx=" + -y * u / f * D + ",Dy=" + -x * d / v * P + ")", W.parentNode || A.appendChild(W), G.parentNode != W && W.appendChild(G)
                    } else H.width = g(D * u) + "px", H.height = g(P * d) + "px", A.appendChild(G), W && W.parentNode && (A.removeChild(W), this._cropEl = null);
                    var U = "", Y = n.opacity;
                    1 > Y && (U += ".Alpha(opacity=" + g(100 * Y) + ") "), U += M + ".AlphaImageLoader(src=" + r + ", SizingMethod=scale)", H.filter = U, A.style.zIndex = z(this.zlevel, this.z, this.z2), L(t, A), n.text && this.drawRectText(t, this.getBoundingRect())
                }
            ...
            var W, H = "normal", q = {}, j = 0, X = 100, U = document.createElement("div"), Y = function (t) {
                var e = q[t];
                if (!e) {
                    j > X && (j = 0, q = {});
                    var i, n = U.style;
            ...
            for (var $ = new r, Q = function (t, e, i, n) {
                ...
                if (o) {
                    ...
                    if (m && !n && ($.copy(e), $.applyTransform(m), e = $), n)a = e.x, l = e.y; else {
                        ...
                        if (v instanceof Array)a = e.x + O(v[0], e.width), l = e.y + O(v[1], e.height), h = h || "left", d = d || "top"; else {
                    ...
                    C ? (A = C.firstChild, M = A.nextSibling, S = M.nextSibling) : (C = T("line"), M = T("path"), S = T("textpath"), A = T("skew"), S.style["v-text-align"] = "left", I(C), M.textpathok = !0, S.on = !0, C.from = "0 0", C.to = "1000 0.05", L(C, A), L(C, M), L(C, S), this._textVmlEl = C);
                    var D = [a, l], P = C.style;
                    m && n ? (b(D, D, m), A.on = !0, A.matrix = m[0].toFixed(3) + w + m[2].toFixed(3) + w + m[1].toFixed(3) + w + m[3].toFixed(3) + ",0,0", A.offset = (g(D[0]) || 0) + "," + (g(D[1]) || 0), A.origin = "0 0", P.left = "0px", P.top = "0px") : (A.on = !1, P.left = g(a) + "px", P.top = g(l) + "px"), S.string = k(o);
                    try {
                        S.style.font = u
                    } catch (E) {
                    }
                    V(C, "fill", {
                        ...
                        opacity: r.opacity,
                        lineDash: r.lineDash
                    }, this), C.style.zIndex = z(this.zlevel, this.z, this.z2), L(t, C)
                }
            }, K = function (t) {
